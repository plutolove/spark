...
public  class AvroPartitionReaderFactory extends org.apache.spark.sql.execution.datasources.v2.FilePartitionReaderFactory implements org.apache.spark.internal.Logging, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.avro.AvroOptions parsedOptions ()  { throw new RuntimeException(); }
  // not preceding
  public   AvroPartitionReaderFactory (org.apache.spark.sql.internal.SQLConf sqlConf, org.apache.spark.broadcast.Broadcast<org.apache.spark.util.SerializableConfiguration> broadcastedConf, org.apache.spark.sql.types.StructType dataSchema, org.apache.spark.sql.types.StructType readDataSchema, org.apache.spark.sql.types.StructType partitionSchema, org.apache.spark.sql.avro.AvroOptions parsedOptions)  { throw new RuntimeException(); }
  // not preceding
