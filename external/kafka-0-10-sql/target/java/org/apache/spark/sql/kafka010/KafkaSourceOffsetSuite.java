...
public  class KafkaSourceOffsetSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.streaming.OffsetSuite, org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public   KafkaSourceOffsetSuite ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.kafka010.KafkaSourceOffset kso1 ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.kafka010.KafkaSourceOffset kso2 ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.kafka010.KafkaSourceOffset kso3 ()  { throw new RuntimeException(); }
  // not preceding
