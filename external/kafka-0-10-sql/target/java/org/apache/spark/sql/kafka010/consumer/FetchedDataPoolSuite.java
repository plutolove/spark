...
public  class FetchedDataPoolSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.test.SharedSparkSession, org.scalatest.PrivateMethodTester {
  // not preceding
  public   FetchedDataPoolSuite ()  { throw new RuntimeException(); }
  ...
  public  scala.collection.mutable.Map<org.apache.spark.sql.kafka010.consumer.KafkaDataConsumer.CacheKey, scala.collection.mutable.ListBuffer<org.apache.spark.sql.kafka010.consumer.FetchedDataPool.CachedFetchedData>> getCache (org.apache.spark.sql.kafka010.consumer.FetchedDataPool pool)  { throw new RuntimeException(); }
  // not preceding
