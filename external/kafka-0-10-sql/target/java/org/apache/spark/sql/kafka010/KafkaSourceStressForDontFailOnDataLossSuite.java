 ...
 * param:  writeToTable the function to write the specified {@link DataFrame} to the given table.
 */
public  class KafkaSourceStressForDontFailOnDataLossSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest, org.apache.spark.sql.kafka010.KafkaMissingOffsetsTest {
  ...
  // not preceding
  public   KafkaSourceStressForDontFailOnDataLossSuite ()  { throw new RuntimeException(); }
