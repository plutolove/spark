...
public abstract class KafkaSinkSuiteBase extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.kafka010.KafkaTest {
  // not preceding
  public   KafkaSinkSuiteBase ()  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> createKafkaReader (java.lang.String topic, boolean includeHeaders)  { throw new RuntimeException(); }
  // not preceding
