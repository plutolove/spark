 ...
 */
public  class KafkaStreamWriterFactory implements org.apache.spark.sql.connector.write.streaming.StreamingDataWriterFactory, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   KafkaStreamWriterFactory (scala.Option<java.lang.String> topic, java.util.Map<java.lang.String, java.lang.Object> producerParams, org.apache.spark.sql.types.StructType schema)  { throw new RuntimeException(); }
  // not preceding
