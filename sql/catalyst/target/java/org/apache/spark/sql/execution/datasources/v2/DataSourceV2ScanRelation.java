...
public  class DataSourceV2ScanRelation extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.analysis.NamedRelation, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   DataSourceV2ScanRelation (org.apache.spark.sql.connector.catalog.Table table, org.apache.spark.sql.connector.read.Scan scan, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> output)  { throw new RuntimeException(); }
  // not preceding
