...
public  class Range$ implements scala.Serializable {
  ...
  // not preceding
  public  org.apache.spark.sql.catalyst.plans.logical.Range apply (long start, long end, long step, scala.Option<java.lang.Object> numSlices, boolean isStreaming)  { throw new RuntimeException(); }
