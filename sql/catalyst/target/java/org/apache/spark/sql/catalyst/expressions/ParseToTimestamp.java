...
public  class ParseToTimestamp extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.RuntimeReplaceable, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ParseToTimestamp (org.apache.spark.sql.catalyst.expressions.Expression left, scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> format, org.apache.spark.sql.catalyst.expressions.Expression child)  { throw new RuntimeException(); }
  // not preceding
