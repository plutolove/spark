...
public  class DateTimeUtilsSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.Matchers, org.apache.spark.sql.catalyst.plans.SQLHelper {
  // not preceding
  public   DateTimeUtilsSuite ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  void testTrunc (int level, java.lang.String expected, long inputTS, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  // not preceding
