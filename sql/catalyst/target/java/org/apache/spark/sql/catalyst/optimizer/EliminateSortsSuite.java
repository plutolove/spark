...
public  class EliminateSortsSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.catalyst.plans.PlanTest {
  // not preceding
  ...
  // not preceding
  // not preceding
  public  class PushDownOptimizer {
    // not preceding
    static public  scala.collection.immutable.List<org.apache.spark.sql.catalyst.rules.RuleExecutor<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan>.Batch> batches ()  { throw new RuntimeException(); }
    static protected  java.lang.String logName ()  { throw new RuntimeException(); }
    static protected  org.slf4j.Logger log ()  { throw new RuntimeException(); }
  ...
  // not preceding
  // not preceding
  public  class PushDownOptimizer$ extends org.apache.spark.sql.catalyst.rules.RuleExecutor<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final PushDownOptimizer$ MODULE$ = null;
    public   PushDownOptimizer$ ()  { throw new RuntimeException(); }
    // not preceding
    public  scala.collection.immutable.List<org.apache.spark.sql.catalyst.rules.RuleExecutor<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan>.Batch> batches ()  { throw new RuntimeException(); }
  }
  // not preceding
  public   EliminateSortsSuite ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.optimizer.EliminateSortsSuite.Optimize$ Optimize ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.optimizer.EliminateSortsSuite.PushDownOptimizer$ PushDownOptimizer ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.catalyst.plans.logical.LocalRelation testRelationB ()  { throw new RuntimeException(); }
}
