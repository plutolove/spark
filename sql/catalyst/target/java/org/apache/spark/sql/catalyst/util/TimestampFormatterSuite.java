...
public  class TimestampFormatterSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.catalyst.util.DatetimeFormatterSuite {
  // not preceding
  public   TimestampFormatterSuite ()  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  public  void checkFormatterCreation (java.lang.String pattern, boolean isParsing)  { throw new RuntimeException(); }
  // not preceding
  ...
  protected  boolean useDateFormatter ()  { throw new RuntimeException(); }
  // not preceding
