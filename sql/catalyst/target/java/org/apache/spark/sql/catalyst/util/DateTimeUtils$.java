...
public  class DateTimeUtils$ {
  ...
  public final  java.sql.Timestamp julianCommonEraStart ()  { throw new RuntimeException(); }
  public final  java.util.TimeZone TimeZoneGMT ()  { throw new RuntimeException(); }
  public final  java.util.TimeZone TimeZoneUTC ()  { throw new RuntimeException(); }
  ...
  public  java.time.ZoneId getZoneId (java.lang.String timeZoneId)  { throw new RuntimeException(); }
  ...
  public  int millisToDays (long millisUtc, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  public  long daysToMillis (int days)  { throw new RuntimeException(); }
  public  long daysToMillis (int days, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  public  java.lang.String timestampToString (org.apache.spark.sql.catalyst.util.TimestampFormatter tf, long us)  { throw new RuntimeException(); }
  /**
   * Converts a local date at the default JVM time zone to the number of days since 1970-01-01
   * in the hybrid calendar (Julian + Gregorian) by discarding the time part. The resulted days are
   * rebased from the hybrid to Proleptic Gregorian calendar. The days rebasing is performed via
  ...
  public  long toMillis (long us)  { throw new RuntimeException(); }
  public  long fromMillis (long millis)  { throw new RuntimeException(); }
  public  int microsToEpochDays (long epochMicros, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  public  long epochDaysToMicros (int epochDays, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  public  java.lang.String cleanLegacyTimestampStr (java.lang.String s)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<java.lang.Object> stringToTimestamp (org.apache.spark.unsafe.types.UTF8String s, java.time.ZoneId timeZoneId)  { throw new RuntimeException(); }
  /**
  ...
  public  int localDateToDays (java.time.LocalDate localDate)  { throw new RuntimeException(); }
  public  java.time.LocalDate daysToLocalDate (int days)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<java.lang.Object> stringToDate (org.apache.spark.unsafe.types.UTF8String s, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getHours (long microsec, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getMinutes (long microsec, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getSeconds (long microsec, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.types.Decimal getSecondsWithFraction (long microsec, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getMicroseconds (long timestamp, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getWeekBasedYear (int date)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long timestampAddInterval (long start, int months, int days, long microseconds, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int dateAddInterval (int start, org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  double monthsBetween (long time1, long time2, boolean roundOff, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  ...
  public  int getLastDayOfMonth (int date)  { throw new RuntimeException(); }
    int TRUNC_INVALID ()  { throw new RuntimeException(); }
    int TRUNC_TO_MICROSECOND ()  { throw new RuntimeException(); }
    int MIN_LEVEL_OF_TIMESTAMP_TRUNC ()  { throw new RuntimeException(); }
    int TRUNC_TO_MILLISECOND ()  { throw new RuntimeException(); }
    int TRUNC_TO_SECOND ()  { throw new RuntimeException(); }
    int TRUNC_TO_MINUTE ()  { throw new RuntimeException(); }
    int TRUNC_TO_HOUR ()  { throw new RuntimeException(); }
    int TRUNC_TO_DAY ()  { throw new RuntimeException(); }
    int TRUNC_TO_WEEK ()  { throw new RuntimeException(); }
    int MIN_LEVEL_OF_DATE_TRUNC ()  { throw new RuntimeException(); }
    int TRUNC_TO_MONTH ()  { throw new RuntimeException(); }
    int TRUNC_TO_QUARTER ()  { throw new RuntimeException(); }
    int TRUNC_TO_YEAR ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long truncTimestamp (long t, int level, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long convertTz (long ts, java.time.ZoneId fromZone, java.time.ZoneId toZone)  { throw new RuntimeException(); }
  /**
  ...
  public  long currentTimestamp ()  { throw new RuntimeException(); }
  public  int currentDate (java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  scala.Option<java.lang.Object> convertSpecialTimestamp (java.lang.String input, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  scala.Option<java.lang.Object> convertSpecialDate (java.lang.String input, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   * Subtracts two dates.
   ...
   */
  public  org.apache.spark.unsafe.types.CalendarInterval subtractDates (int endDate, int startDate)  { throw new RuntimeException(); }
}
