...
public  class JacksonParser implements org.apache.spark.internal.Logging {
  // not preceding
  public   JacksonParser (org.apache.spark.sql.types.DataType schema, org.apache.spark.sql.catalyst.json.JSONOptions options, boolean allowArrayAsStructs)  { throw new RuntimeException(); }
  /**
   * Create a converter which converts the JSON documents held by the <code>JsonParser</code>
