...
/** alias should be eliminated by {@link CleanupAliases} */
public  class AnalysisSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.catalyst.analysis.AnalysisTest, org.scalatest.Matchers {
  // not preceding
  public   AnalysisSuite ()  { throw new RuntimeException(); }
  // not preceding
