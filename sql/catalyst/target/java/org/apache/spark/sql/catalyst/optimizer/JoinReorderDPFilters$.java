...
public  class JoinReorderDPFilters$ implements org.apache.spark.sql.catalyst.expressions.PredicateHelper {
  ...
  // not preceding
  public  scala.Option<org.apache.spark.sql.catalyst.optimizer.JoinGraphInfo> buildJoinGraphInfo (org.apache.spark.sql.internal.SQLConf conf, scala.collection.Seq<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> items, scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> conditions, scala.collection.Seq<scala.Tuple2<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, java.lang.Object>> itemIndex)  { throw new RuntimeException(); }
  /**
