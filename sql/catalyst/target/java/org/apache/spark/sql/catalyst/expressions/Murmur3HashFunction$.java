...
// not preceding
public  class Murmur3HashFunction$ extends org.apache.spark.sql.catalyst.expressions.InterpretedHashFunction {
  /**
   * Static reference to the singleton instance of this Scala object.
   */
  public static final Murmur3HashFunction$ MODULE$ = null;
  public   Murmur3HashFunction$ ()  { throw new RuntimeException(); }
  // not preceding
