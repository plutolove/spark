...
public  class MakeTimestamp extends org.apache.spark.sql.catalyst.expressions.SeptenaryExpression implements org.apache.spark.sql.catalyst.expressions.TimeZoneAwareExpression, org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   MakeTimestamp (org.apache.spark.sql.catalyst.expressions.Expression year, org.apache.spark.sql.catalyst.expressions.Expression month, org.apache.spark.sql.catalyst.expressions.Expression day, org.apache.spark.sql.catalyst.expressions.Expression hour, org.apache.spark.sql.catalyst.expressions.Expression min, org.apache.spark.sql.catalyst.expressions.Expression sec, scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> timezone, scala.Option<java.lang.String> timeZoneId)  { throw new RuntimeException(); }
  // not preceding
