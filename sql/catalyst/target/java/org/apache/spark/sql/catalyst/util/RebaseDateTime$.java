...
public  class RebaseDateTime$ {
   ...
   */
    long rebaseGregorianToJulianMicros (java.time.ZoneId zoneId, long micros)  { throw new RuntimeException(); }
  /**
   ...
   */
    long rebaseJulianToGregorianMicros (java.time.ZoneId zoneId, long micros)  { throw new RuntimeException(); }
