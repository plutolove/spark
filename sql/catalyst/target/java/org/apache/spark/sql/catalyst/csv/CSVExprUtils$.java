...
public  class CSVExprUtils$ {
   ...
   */
  public static final CSVExprUtils$ MODULE$ = null;
  public   CSVExprUtils$ ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  scala.collection.Iterator<java.lang.String> skipComments (scala.collection.Iterator<java.lang.String> iter, org.apache.spark.sql.catalyst.csv.CSVOptions options)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<java.lang.String> extractHeader (scala.collection.Iterator<java.lang.String> iter, org.apache.spark.sql.catalyst.csv.CSVOptions options)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  java.lang.String toDelimiterStr (java.lang.String str)  { throw new RuntimeException(); }
}
