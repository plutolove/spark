...
public  class RandomDataGenerator {
   ...
   * @return (undocumented)
   */
  static public  float intBitsToFloat (int bits)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  double longBitsToDouble (long bits)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  scala.Option<scala.Function0<java.lang.Object>> forType (org.apache.spark.sql.types.DataType dataType, boolean nullable, scala.util.Random rand, boolean validJulianDatetime)  { throw new RuntimeException(); }
