 ...
 */
// not preceding
public  class CodegenObjectFactoryMode {
  // not preceding
  static public  scala.Enumeration.Value FALLBACK ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value CODEGEN_ONLY ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value NO_CODEGEN ()  { throw new RuntimeException(); }
