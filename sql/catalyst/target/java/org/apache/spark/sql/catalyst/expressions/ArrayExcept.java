 ...
 */
public  class ArrayExcept extends org.apache.spark.sql.catalyst.expressions.BinaryExpression implements org.apache.spark.sql.catalyst.expressions.ArrayBinaryLike, org.apache.spark.sql.catalyst.expressions.ComplexTypeMergingExpression, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ArrayExcept (org.apache.spark.sql.catalyst.expressions.Expression left, org.apache.spark.sql.catalyst.expressions.Expression right)  { throw new RuntimeException(); }
  // not preceding
  public  org.apache.spark.sql.types.DataType dataType ()  { throw new RuntimeException(); }
  // not preceding
  public  scala.Function2<org.apache.spark.sql.catalyst.util.ArrayData, org.apache.spark.sql.catalyst.util.ArrayData, org.apache.spark.sql.catalyst.util.ArrayData> evalExcept ()  { throw new RuntimeException(); }
