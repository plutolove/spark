 ...
 * @param <T>  Generic type for primitives
 */
public  class MathExpressionsSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.catalyst.expressions.ExpressionEvalHelper {
  // not preceding
  ...
  public  org.apache.spark.sql.catalyst.expressions.Expression checkDataTypeAndCast (org.apache.spark.sql.catalyst.expressions.UnaryMathExpression expression)  { throw new RuntimeException(); }
  // not preceding
