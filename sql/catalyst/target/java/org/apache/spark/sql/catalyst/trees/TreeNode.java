 ...
 * when this node is copied via <code>makeCopy</code>, or transformed via <code>transformUp</code>/<code>transformDown</code>.
 */
public abstract class TreeNode<BaseType extends org.apache.spark.sql.catalyst.trees.TreeNode<BaseType>> implements scala.Product {
  ...
  protected  void copyTagsFrom (BaseType other)  { throw new RuntimeException(); }
  /**
