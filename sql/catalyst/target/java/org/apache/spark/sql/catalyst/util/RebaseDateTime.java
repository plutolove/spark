 ...
 * <p>
 * It finds the latest switch day which is less than the given <code>days</code>, and adds the difference
 * in days associated with the switch days to the given <code>days</code>.
...
public  class RebaseDateTime {
   ...
   */
  static   long rebaseGregorianToJulianMicros (java.time.ZoneId zoneId, long micros)  { throw new RuntimeException(); }
  /**
   ...
   */
  static   long rebaseJulianToGregorianMicros (java.time.ZoneId zoneId, long micros)  { throw new RuntimeException(); }
