...
public  class AstBuilder extends org.apache.spark.sql.catalyst.parser.SqlBaseBaseVisitor<java.lang.Object> implements org.apache.spark.internal.Logging {
  ...
  public  org.apache.spark.sql.types.DataType parseRawDataType (org.apache.spark.sql.catalyst.parser.SqlBaseParser.SingleDataTypeContext ctx)  { throw new RuntimeException(); }
  ...
  /**
   * Create an {@link AlterTableAddPartitionStatement}.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Alter the query of a view. This creates a {@link AlterViewAsStatement}
   * <p>
   * For example:
   * <pre><code>
  ...
  public  scala.Tuple6<scala.collection.Seq<org.apache.spark.sql.connector.expressions.Transform>, scala.Option<org.apache.spark.sql.catalyst.catalog.BucketSpec>, scala.collection.immutable.Map<java.lang.String, java.lang.String>, scala.collection.immutable.Map<java.lang.String, java.lang.String>, scala.Option<java.lang.String>, scala.Option<java.lang.String>> visitCreateTableClauses (org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateTableClausesContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Create a {@link DescribeColumnStatement} or {@link DescribeRelation} commands.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  ...
  /**
   * Create a {@link RenameTableStatement} command.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Create an {@link AlterNamespaceSetLocation} logical plan.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Create an {@link AlterNamespaceSetProperties} logical plan.
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Create an {@link AlterTableSerDePropertiesStatement}
   * <p>
   * For example:
   * <pre><code>
  ...
  /**
   * Create a {@link ShowTableStatement} command.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
