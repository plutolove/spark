...
public  class FakeV2SessionCatalog {
  ...
  static public  void invalidateTable (org.apache.spark.sql.connector.catalog.Identifier ident)  { throw new RuntimeException(); }
  static public  boolean tableExists (org.apache.spark.sql.connector.catalog.Identifier ident)  { throw new RuntimeException(); }
}
