...
public  class PropagateEmptyRelationSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.catalyst.plans.PlanTest {
  // not preceding
  // not preceding
  ...
  // not preceding
  // not preceding
  public  class OptimizeWithoutPropagateEmptyRelation {
    // not preceding
    static public  scala.collection.immutable.List<org.apache.spark.sql.catalyst.rules.RuleExecutor<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan>.Batch> batches ()  { throw new RuntimeException(); }
    static protected  java.lang.String logName ()  { throw new RuntimeException(); }
    static protected  org.slf4j.Logger log ()  { throw new RuntimeException(); }
  ...
  // not preceding
  // not preceding
  public  class OptimizeWithoutPropagateEmptyRelation$ extends org.apache.spark.sql.catalyst.rules.RuleExecutor<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final OptimizeWithoutPropagateEmptyRelation$ MODULE$ = null;
    public   OptimizeWithoutPropagateEmptyRelation$ ()  { throw new RuntimeException(); }
    // not preceding
    public  scala.collection.immutable.List<org.apache.spark.sql.catalyst.rules.RuleExecutor<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan>.Batch> batches ()  { throw new RuntimeException(); }
  }
  public  org.apache.spark.sql.catalyst.optimizer.PropagateEmptyRelationSuite.Optimize$ Optimize ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.optimizer.PropagateEmptyRelationSuite.OptimizeWithoutPropagateEmptyRelation$ OptimizeWithoutPropagateEmptyRelation ()  { throw new RuntimeException(); }
  // not preceding
  public   PropagateEmptyRelationSuite ()  { throw new RuntimeException(); }
  // not preceding
  protected  java.lang.String sparkHome ()  { throw new RuntimeException(); }
  // not preceding
  public  org.apache.spark.sql.catalyst.plans.logical.LocalRelation testRelation1 ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.plans.logical.LocalRelation testRelation2 ()  { throw new RuntimeException(); }
}
