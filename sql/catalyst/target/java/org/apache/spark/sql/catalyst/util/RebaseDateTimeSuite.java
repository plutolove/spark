...
public  class RebaseDateTimeSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.Matchers, org.apache.spark.sql.catalyst.plans.SQLHelper {
  // not preceding
  public   RebaseDateTimeSuite ()  { throw new RuntimeException(); }
  // not preceding
