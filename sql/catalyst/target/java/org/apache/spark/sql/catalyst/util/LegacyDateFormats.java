...
// not preceding
public  class LegacyDateFormats {
  static public  scala.Enumeration.Value FAST_DATE_FORMAT ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value SIMPLE_DATE_FORMAT ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value LENIENT_SIMPLE_DATE_FORMAT ()  { throw new RuntimeException(); }
