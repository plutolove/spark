...
public  class PROCESS_TABLES {
  ...
  static public  org.apache.spark.sql.test.SQLTestUtilsBase.testImplicits$ testImplicits ()  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  static protected  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> lowerCaseDataWithDuplicates ()  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  static protected  org.apache.spark.rdd.RDD<org.apache.spark.sql.test.SQLTestData.IntervalData> calenderIntervalData ()  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  static protected  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> trainingSales ()  { throw new RuntimeException(); }
  ...
  // not preceding
  static public  java.lang.String releaseMirror ()  { throw new RuntimeException(); }
  static public  scala.collection.Seq<java.lang.String> testingVersions ()  { throw new RuntimeException(); }
  ...
  static protected  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan normalizePlan (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
  static protected  void comparePlans (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan1, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan2, boolean checkAnalysis)  { throw new RuntimeException(); }
  static protected  boolean comparePlans$default$3 ()  { throw new RuntimeException(); }
  ...
  static protected  void compareJoinOrder (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan1, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan2)  { throw new RuntimeException(); }
  ...
  static public  void assertCached (org.apache.spark.sql.Dataset<?> query, java.lang.String cachedName, org.apache.spark.storage.StorageLevel storageLevel)  { throw new RuntimeException(); }
  ...
  static public  org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig org$scalatest$concurrent$PatienceConfiguration$$defaultPatienceConfig ()  { throw new RuntimeException(); }
  static public  org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig patienceConfig ()  { throw new RuntimeException(); }
  ...
  static protected abstract  void org$scalatest$concurrent$PatienceConfiguration$_setter_$org$scalatest$concurrent$PatienceConfiguration$$defaultPatienceConfig_$eq (org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig x$1)  ;
  static public <T extends java.lang.Object> T eventually (org.scalatest.concurrent.PatienceConfiguration.Timeout timeout, org.scalatest.concurrent.PatienceConfiguration.Interval interval, scala.Function0<T> fun, org.scalactic.source.Position pos)  { throw new RuntimeException(); }
  static public <T extends java.lang.Object> T eventually (org.scalatest.concurrent.PatienceConfiguration.Timeout timeout, scala.Function0<T> fun, org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig config, org.scalactic.source.Position pos)  { throw new RuntimeException(); }
  static public <T extends java.lang.Object> T eventually (org.scalatest.concurrent.PatienceConfiguration.Interval interval, scala.Function0<T> fun, org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig config, org.scalactic.source.Position pos)  { throw new RuntimeException(); }
  static public <T extends java.lang.Object> T eventually (scala.Function0<T> fun, org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig config, org.scalactic.source.Position pos)  { throw new RuntimeException(); }
  ...
  static protected  void withTempView (scala.collection.Seq<java.lang.String> viewNames, scala.Function0<scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
  static protected  void withGlobalTempView (scala.collection.Seq<java.lang.String> viewNames, scala.Function0<scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
  ...
  static protected  void withCache (scala.collection.Seq<java.lang.String> cacheNames, scala.Function0<scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
  static protected  void uncacheTable (java.lang.String tableName)  { throw new RuntimeException(); }
  ...
  static protected  void withDatabase (scala.collection.Seq<java.lang.String> dbNames, scala.Function0<scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
  static protected  void withNamespace (scala.collection.Seq<java.lang.String> namespaces, scala.Function0<scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
  static protected  void withLocale (java.lang.String language, scala.Function0<scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
  ...
  static public  java.net.URI makeQualifiedPath (java.lang.String path)  { throw new RuntimeException(); }
  static protected  java.lang.String testFile (java.lang.String fileName)  { throw new RuntimeException(); }
  static public  long getLocalDirSize (java.io.File file)  { throw new RuntimeException(); }
  static public  boolean org$apache$spark$sql$test$SQLTestUtils$$loadTestDataBeforeTests ()  { throw new RuntimeException(); }
  static public  void org$apache$spark$sql$test$SQLTestUtils$$loadTestDataBeforeTests_$eq (boolean x$1)  { throw new RuntimeException(); }
  ...
  static protected  void testWithWholeStageCodegenOnAndOff (java.lang.String testName, scala.Function1<java.lang.String, scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
  ...
  static protected  void withResourceTempPath (java.lang.String resourcePath, scala.Function1<java.io.File, scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
  static protected  void waitForTasksToFinish ()  { throw new RuntimeException(); }
  static protected  void withTempPaths (int numPaths, scala.Function1<scala.collection.Seq<java.io.File>, scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
}
