...
public  class HiveSchemaInferenceSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.hive.test.TestHiveSingleton, org.apache.spark.sql.test.SQLTestUtils, org.scalatest.BeforeAndAfterEach {
  // not preceding
  ...
  // not preceding
  public   HiveSchemaInferenceSuite ()  { throw new RuntimeException(); }
  // not preceding
