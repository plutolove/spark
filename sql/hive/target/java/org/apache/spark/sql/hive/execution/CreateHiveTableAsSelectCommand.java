 ...
 * param:  mode SaveMode
 */
public  class CreateHiveTableAsSelectCommand extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements org.apache.spark.sql.hive.execution.CreateHiveTableAsSelectBase, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CreateHiveTableAsSelectCommand (org.apache.spark.sql.catalyst.catalog.CatalogTable tableDesc, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, scala.collection.Seq<java.lang.String> outputColumnNames, org.apache.spark.sql.SaveMode mode)  { throw new RuntimeException(); }
  // not preceding
