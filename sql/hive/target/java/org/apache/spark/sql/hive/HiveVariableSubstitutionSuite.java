...
public  class HiveVariableSubstitutionSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.hive.test.TestHiveSingleton {
  // not preceding
  public   HiveVariableSubstitutionSuite ()  { throw new RuntimeException(); }
  // not preceding
