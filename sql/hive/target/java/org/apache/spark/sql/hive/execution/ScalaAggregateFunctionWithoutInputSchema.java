...
public  class ScalaAggregateFunctionWithoutInputSchema extends org.apache.spark.sql.expressions.UserDefinedAggregateFunction {
  // not preceding
  public   ScalaAggregateFunctionWithoutInputSchema ()  { throw new RuntimeException(); }
