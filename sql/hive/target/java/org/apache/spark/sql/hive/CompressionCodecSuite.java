...
public  class CompressionCodecSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.hive.test.TestHiveSingleton, org.apache.spark.sql.execution.datasources.parquet.ParquetTest, org.scalatest.BeforeAndAfterAll {
  // not preceding
  public   CompressionCodecSuite ()  { throw new RuntimeException(); }
  ...
  public  void checkForTableWithCompressProp (java.lang.String format, scala.collection.immutable.List<java.lang.String> tableCompressCodecs, scala.collection.immutable.List<java.lang.String> sessionCompressCodecs)  { throw new RuntimeException(); }
  public  void checkTableWriteWithCompressionCodecs (java.lang.String format, scala.collection.immutable.List<java.lang.String> compressCodecs)  { throw new RuntimeException(); }
  // not preceding
