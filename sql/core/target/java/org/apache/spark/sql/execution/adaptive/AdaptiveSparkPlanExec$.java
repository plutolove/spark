...
public  class AdaptiveSparkPlanExec$ implements scala.Serializable {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.execution.SparkPlan applyPhysicalRules (org.apache.spark.sql.execution.SparkPlan plan, scala.collection.Seq<org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.execution.SparkPlan>> rules)  { throw new RuntimeException(); }
}
