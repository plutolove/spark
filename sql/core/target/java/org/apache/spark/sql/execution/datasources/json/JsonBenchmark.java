...
public  class JsonBenchmark {
  ...
  static public  void schemaInferring (int rowsNum, int numIters)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.types.StructType writeShortColumn (java.lang.String path, int rowsNum)  { throw new RuntimeException(); }
  static public  void countShortColumn (int rowsNum, int numIters)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.types.StructType writeWideColumn (java.lang.String path, int rowsNum)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.types.StructType writeWideRow (java.lang.String path, int rowsNum)  { throw new RuntimeException(); }
  static public  void countWideColumn (int rowsNum, int numIters)  { throw new RuntimeException(); }
  static public  void countWideRow (int rowsNum, int numIters)  { throw new RuntimeException(); }
  static public  void selectSubsetOfColumns (int rowsNum, int numIters)  { throw new RuntimeException(); }
  static public  void jsonParserCreation (int rowsNum, int numIters)  { throw new RuntimeException(); }
  static public  void jsonFunctions (int rows, int iters)  { throw new RuntimeException(); }
  static public  void jsonInDS (int rows, int iters)  { throw new RuntimeException(); }
  static public  void jsonInFile (int rows, int iters)  { throw new RuntimeException(); }
