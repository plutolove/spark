...
public  class OrcScanBuilder extends org.apache.spark.sql.execution.datasources.v2.FileScanBuilder implements org.apache.spark.sql.connector.read.SupportsPushDownFilters, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   OrcScanBuilder (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.execution.datasources.PartitioningAwareFileIndex fileIndex, org.apache.spark.sql.types.StructType schema, org.apache.spark.sql.types.StructType dataSchema, org.apache.spark.sql.util.CaseInsensitiveStringMap options)  { throw new RuntimeException(); }
  // not preceding
