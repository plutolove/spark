...
public  class SQLExecution$ {
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> T withNewExecutionId (org.apache.spark.sql.execution.QueryExecution queryExecution, scala.Option<java.lang.String> name, scala.Function0<T> body)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> java.util.concurrent.Future<T> withThreadLocalCaptured (org.apache.spark.sql.SparkSession sparkSession, java.util.concurrent.ExecutorService exec, scala.Function0<T> body)  { throw new RuntimeException(); }
}
