...
public  interface AdaptiveSparkPlanHelper {
  ...
  /**
   * Returns a cloned {@link SparkSession} with adaptive execution disabled, or the original
   * {@link SparkSession} if its adaptive execution is already disabled.
   * @param session (undocumented)
   * @return (undocumented)
   */
  public <T extends java.lang.Object> org.apache.spark.sql.SparkSession getOrCloneSessionWithAqeOff (org.apache.spark.sql.SparkSession session)  ;
  /**
