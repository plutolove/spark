...
public  class ForeachWriterSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest, org.apache.spark.sql.test.SharedSparkSession, org.scalatest.BeforeAndAfter {
  // not preceding
  static public  class Open implements org.apache.spark.sql.execution.streaming.sources.ForeachWriterSuite.Event, scala.Product, scala.Serializable {
    // not preceding
    public  long partition ()  { throw new RuntimeException(); }
    public  long version ()  { throw new RuntimeException(); }
    // not preceding
    public   Open (long partition, long version)  { throw new RuntimeException(); }
  }
  // not preceding
  static public  class Open$ extends scala.runtime.AbstractFunction2<java.lang.Object, java.lang.Object, org.apache.spark.sql.execution.streaming.sources.ForeachWriterSuite.Open> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final Open$ MODULE$ = null;
    public   Open$ ()  { throw new RuntimeException(); }
  }
  // not preceding
  static public  class Process<T extends java.lang.Object> implements org.apache.spark.sql.execution.streaming.sources.ForeachWriterSuite.Event, scala.Product, scala.Serializable {
    public  T value ()  { throw new RuntimeException(); }
    // not preceding
    public   Process (T value)  { throw new RuntimeException(); }
  }
  // not preceding
  static public  class Process$ implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final Process$ MODULE$ = null;
    public   Process$ ()  { throw new RuntimeException(); }
  }
  // not preceding
  static public  class Close implements org.apache.spark.sql.execution.streaming.sources.ForeachWriterSuite.Event, scala.Product, scala.Serializable {
    // not preceding
    public  scala.Option<java.lang.Throwable> error ()  { throw new RuntimeException(); }
    // not preceding
    public   Close (scala.Option<java.lang.Throwable> error)  { throw new RuntimeException(); }
  }
  // not preceding
  static public  class Close$ extends scala.runtime.AbstractFunction1<scala.Option<java.lang.Throwable>, org.apache.spark.sql.execution.streaming.sources.ForeachWriterSuite.Close> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final Close$ MODULE$ = null;
    public   Close$ ()  { throw new RuntimeException(); }
  }
  // not preceding
  static public  interface Event {
  }
  static public  void addEvents (scala.collection.Seq<org.apache.spark.sql.execution.streaming.sources.ForeachWriterSuite.Event> events)  { throw new RuntimeException(); }
  static public  scala.collection.Seq<scala.collection.Seq<org.apache.spark.sql.execution.streaming.sources.ForeachWriterSuite.Event>> allEvents ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   ForeachWriterSuite ()  { throw new RuntimeException(); }
}
