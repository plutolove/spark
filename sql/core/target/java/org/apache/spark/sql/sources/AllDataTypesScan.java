...
public  class AllDataTypesScan extends org.apache.spark.sql.sources.BaseRelation implements org.apache.spark.sql.sources.TableScan, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   AllDataTypesScan (int from, int to, org.apache.spark.sql.types.StructType userSpecifiedSchema, org.apache.spark.sql.SparkSession sparkSession)  { throw new RuntimeException(); }
  // not preceding
