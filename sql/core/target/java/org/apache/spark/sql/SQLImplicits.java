...
public abstract class SQLImplicits implements org.apache.spark.sql.LowPrioritySQLImplicits {
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> org.apache.spark.sql.DatasetHolder<T> localSeqToDatasetHolder (scala.collection.Seq<T> s, org.apache.spark.sql.Encoder<T> evidence$7)  { throw new RuntimeException(); }
  /** @since 1.6.1 */
  ...
  /** @since 2.3.0 */
  public <T extends scala.collection.Map<?, ?>> org.apache.spark.sql.Encoder<T> newMapEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$3)  { throw new RuntimeException(); }
  /** @since 1.6.1 */
  public <A extends scala.Product> org.apache.spark.sql.Encoder<java.lang.Object> newProductArrayEncoder (scala.reflect.api.TypeTags.TypeTag<A> evidence$5)  { throw new RuntimeException(); }
  /**
   * @since 1.6.1
   * @deprecated use {@link newSequenceEncoder}
  ...
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<?>> org.apache.spark.sql.Encoder<T> newSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$2)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends scala.collection.immutable.Set<?>> org.apache.spark.sql.Encoder<T> newSetEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$4)  { throw new RuntimeException(); }
  /** @since 1.6.1 */
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> org.apache.spark.sql.DatasetHolder<T> rddToDatasetHolder (org.apache.spark.rdd.RDD<T> rdd, org.apache.spark.sql.Encoder<T> evidence$6)  { throw new RuntimeException(); }
  /**
