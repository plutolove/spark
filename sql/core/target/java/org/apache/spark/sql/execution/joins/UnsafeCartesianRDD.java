...
public  class UnsafeCartesianRDD extends org.apache.spark.rdd.CartesianRDD<org.apache.spark.sql.catalyst.expressions.UnsafeRow, org.apache.spark.sql.catalyst.expressions.UnsafeRow> {
  // not preceding
  public   UnsafeCartesianRDD (org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.expressions.UnsafeRow> left, org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.expressions.UnsafeRow> right, int numFieldsOfRight, int inMemoryBufferThreshold, int spillThreshold)  { throw new RuntimeException(); }
  // not preceding
