 ...
 */
// not preceding
public  class CleanSourceMode {
  // not preceding
  static public  scala.Enumeration.Value ARCHIVE ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value DELETE ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value OFF ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value fromString (scala.Option<java.lang.String> value)  { throw new RuntimeException(); }
