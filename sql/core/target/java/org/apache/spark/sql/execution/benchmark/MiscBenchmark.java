...
public  class MiscBenchmark {
  ...
  // not preceding
  static public  void filterAndAggregateWithoutGroup (long numRows)  { throw new RuntimeException(); }
  static public  void limitAndAggregateWithoutGroup (long numRows)  { throw new RuntimeException(); }
  static public  void sample (int numRows)  { throw new RuntimeException(); }
  static public  void collect (int numRows)  { throw new RuntimeException(); }
  static public  void collectLimit (int numRows)  { throw new RuntimeException(); }
  static public  void explode (int numRows)  { throw new RuntimeException(); }
  static public  void stack (int numRows)  { throw new RuntimeException(); }
