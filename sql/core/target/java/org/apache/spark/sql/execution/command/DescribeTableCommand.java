...
public  class DescribeTableCommand extends org.apache.spark.sql.execution.command.DescribeCommandBase implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   DescribeTableCommand (org.apache.spark.sql.catalyst.TableIdentifier table, scala.collection.immutable.Map<java.lang.String, java.lang.String> partitionSpec, boolean isExtended)  { throw new RuntimeException(); }
  // not preceding
