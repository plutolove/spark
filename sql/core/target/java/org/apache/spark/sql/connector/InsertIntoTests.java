 ...
 * ("INSERT") or using the DataFrameWriter (<code>df.write.insertInto</code>).
 */
public abstract class InsertIntoTests extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.connector.InsertIntoSQLOnlyTests {
  // not preceding
  public   InsertIntoTests (boolean supportsDynamicOverwrite, boolean includeSQLOnlyTests)  { throw new RuntimeException(); }
  ...
  // not preceding
  protected abstract  void doInsert (java.lang.String tableName, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> insert, org.apache.spark.sql.SaveMode mode)  ;
  // not preceding
  protected  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> emptyTestData ()  { throw new RuntimeException(); }
  // not preceding
  protected  boolean enableAutoThreadAudit ()  { throw new RuntimeException(); }
  protected  boolean includeSQLOnlyTests ()  { throw new RuntimeException(); }
  // not preceding
  ...
  protected  boolean supportsDynamicOverwrite ()  { throw new RuntimeException(); }
  // not preceding
