...
public  class StreamingAggregationStateManagerSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest {
  ...
  // not preceding
  public   StreamingAggregationStateManagerSuite ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  org.apache.spark.sql.catalyst.expressions.UnsafeRow expectedTestKeyRow ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.expressions.UnsafeRow expectedTestValueRowForV2 ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.types.StructType expectedTestValuesSchema ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> testKeyAttributes ()  { throw new RuntimeException(); }
  // not preceding
  public  scala.collection.Seq<java.lang.String> testKeys ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> testOutputAttributes ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.types.StructType testOutputSchema ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.expressions.UnsafeRow testRow ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<java.lang.String> testValues ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> testValuesAttributes ()  { throw new RuntimeException(); }
  // not preceding
