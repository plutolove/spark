...
public  class IntDelta {
  static public  class Encoder implements org.apache.spark.sql.execution.columnar.compression.Encoder<org.apache.spark.sql.types.IntegerType$> {
    // not preceding
  ...
  // not preceding
  static public  class Decoder implements org.apache.spark.sql.execution.columnar.compression.Decoder<org.apache.spark.sql.types.IntegerType$> {
    // not preceding
    public   Decoder (java.nio.ByteBuffer buffer, org.apache.spark.sql.execution.columnar.NativeColumnType<org.apache.spark.sql.types.IntegerType$> columnType)  { throw new RuntimeException(); }
