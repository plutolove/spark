...
public  class HadoopFileLinesReaderSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public   HadoopFileLinesReaderSuite ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public  scala.collection.Seq<java.lang.String> getLines (java.io.File path, java.lang.String text, scala.collection.Seq<scala.Tuple2<java.lang.Object, java.lang.Object>> ranges, scala.Option<java.lang.String> delimiter, scala.Option<org.apache.hadoop.conf.Configuration> conf)  { throw new RuntimeException(); }
  // not preceding
