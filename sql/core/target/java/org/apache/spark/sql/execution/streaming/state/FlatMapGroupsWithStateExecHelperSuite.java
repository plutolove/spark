...
public  class FlatMapGroupsWithStateExecHelperSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest {
  ...
  // not preceding
  public   FlatMapGroupsWithStateExecHelperSuite ()  { throw new RuntimeException(); }
  ...
  public <T extends java.lang.Object> void testStateManagerWithTimestamp (int version, org.apache.spark.sql.types.StructType expectedStateSchema, scala.collection.Seq<T> testValues, org.apache.spark.sql.Encoder<T> evidence$2)  { throw new RuntimeException(); }
  public <T extends java.lang.Object> void testStateManagerWithoutTimestamp (int version, org.apache.spark.sql.types.StructType expectedStateSchema, scala.collection.Seq<T> testValues, org.apache.spark.sql.Encoder<T> evidence$1)  { throw new RuntimeException(); }
  // not preceding
