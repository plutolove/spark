...
public  class PartitioningUtils$ {
  ...
  // not preceding
    org.apache.spark.sql.execution.datasources.PartitionSpec parsePartitions (scala.collection.Seq<org.apache.hadoop.fs.Path> paths, boolean typeInference, scala.collection.immutable.Set<org.apache.hadoop.fs.Path> basePaths, scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema, boolean caseSensitive, boolean validatePartitionColumns, java.lang.String timeZoneId)  { throw new RuntimeException(); }
    org.apache.spark.sql.execution.datasources.PartitionSpec parsePartitions (scala.collection.Seq<org.apache.hadoop.fs.Path> paths, boolean typeInference, scala.collection.immutable.Set<org.apache.hadoop.fs.Path> basePaths, scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema, boolean caseSensitive, boolean validatePartitionColumns, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.Seq<org.apache.spark.sql.execution.datasources.PartitioningUtils.PartitionValues> resolvePartitions (scala.collection.Seq<scala.Tuple2<org.apache.hadoop.fs.Path, org.apache.spark.sql.execution.datasources.PartitioningUtils.PartitionValues>> pathsWithPartitionValues, boolean caseSensitive, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
    org.apache.spark.sql.catalyst.expressions.Literal inferPartitionColumnValue (java.lang.String raw, boolean typeInference, java.time.ZoneId zoneId, org.apache.spark.sql.catalyst.util.DateFormatter dateFormatter, org.apache.spark.sql.catalyst.util.TimestampFormatter timestampFormatter)  { throw new RuntimeException(); }
