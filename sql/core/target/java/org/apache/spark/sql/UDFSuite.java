...
public  class UDFSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public  class MalformedClassObject {
    // not preceding
    static public  class MalformedNonPrimitiveFunction implements scala.Function1<java.lang.String, java.lang.Object>, scala.Serializable {
      // not preceding
      public   MalformedNonPrimitiveFunction ()  { throw new RuntimeException(); }
      // not preceding
      public  int apply (java.lang.String v1)  { throw new RuntimeException(); }
    }
    // not preceding
    static public  class MalformedPrimitiveFunction implements scala.Function1<java.lang.Object, java.lang.Object>, scala.Serializable {
      // not preceding
      public   MalformedPrimitiveFunction ()  { throw new RuntimeException(); }
      // not preceding
      public  int apply (int v1)  { throw new RuntimeException(); }
    }
  }
  // not preceding
  ...
  public  org.apache.spark.sql.UDFSuite.MalformedClassObject$ MalformedClassObject ()  { throw new RuntimeException(); }
