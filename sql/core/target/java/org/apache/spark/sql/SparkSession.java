...
public  class SparkSession implements scala.Serializable, java.io.Closeable, org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
    scala.collection.mutable.HashMap<java.lang.String, java.lang.String> initialSessionOptions ()  { throw new RuntimeException(); }
  // not preceding
  ...
  /**
   * Returns the specified table/view as a <code>DataFrame</code>.
   * <p>
  ...
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> table (java.lang.String tableName)  { throw new RuntimeException(); }
    org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> table (scala.collection.Seq<java.lang.String> multipartIdentifier)  { throw new RuntimeException(); }
