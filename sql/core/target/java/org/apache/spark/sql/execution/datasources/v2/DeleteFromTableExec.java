...
public  class DeleteFromTableExec extends org.apache.spark.sql.execution.datasources.v2.V2CommandExec implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   DeleteFromTableExec (org.apache.spark.sql.connector.catalog.SupportsDelete table, org.apache.spark.sql.sources.Filter[] condition)  { throw new RuntimeException(); }
  // not preceding
