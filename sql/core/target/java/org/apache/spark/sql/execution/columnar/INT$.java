 ...
 */
// not preceding
public  class INT$ extends org.apache.spark.sql.execution.columnar.NativeColumnType<org.apache.spark.sql.types.IntegerType$> {
  /**
  ...
  public  void setField (org.apache.spark.sql.catalyst.InternalRow row, int ordinal, int value)  { throw new RuntimeException(); }
