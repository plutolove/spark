...
public  class ForeachBatchSinkSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest {
  ...
  // not preceding
  public   ForeachBatchSinkSuite ()  { throw new RuntimeException(); }
