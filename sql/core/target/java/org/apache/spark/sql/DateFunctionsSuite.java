...
public  class DateFunctionsSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  ...
  public  void checkExceptionMessage (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  java.sql.Date d ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  java.text.SimpleDateFormat sdfDate ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  java.sql.Timestamp ts ()  { throw new RuntimeException(); }
  // not preceding
