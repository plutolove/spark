...
public  class CommandUtils$ implements org.apache.spark.internal.Logging {
  ...
  public  long calculateTotalLocationSize (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.TableIdentifier tid, scala.collection.Seq<scala.Option<java.net.URI>> paths)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  long calculateLocationSizeParallel (org.apache.spark.sql.SparkSession sparkSession, scala.collection.Seq<scala.Option<org.apache.hadoop.fs.Path>> paths)  { throw new RuntimeException(); }
