...
public  class TypedImperativeAggregateSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  ...
  // not preceding
  public   TypedImperativeAggregateSuite ()  { throw new RuntimeException(); }
}
