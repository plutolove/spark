...
public  class ContinuousShuffleReadPartition implements org.apache.spark.Partition, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ContinuousShuffleReadPartition (int index, java.lang.String endpointName, int queueSize, int numShuffleWriters, long epochIntervalMs)  { throw new RuntimeException(); }
