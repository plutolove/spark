...
public  class ContinuousShuffleSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest {
  ...
  // not preceding
  public   ContinuousShuffleSuite ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public  org.apache.spark.TaskContextImpl ctx ()  { throw new RuntimeException(); }
  // not preceding
