 ...
 * test nested cases.
 */
public abstract class ParquetFilterSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.execution.datasources.parquet.ParquetTest, org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  ...
  // not preceding
  protected  org.apache.spark.sql.execution.datasources.parquet.ParquetFilters createParquetFilters (org.apache.parquet.schema.MessageType schema, scala.Option<java.lang.Object> caseSensitive)  { throw new RuntimeException(); }
  // not preceding
