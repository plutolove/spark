...
public  class BinaryFileFormatSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public   BinaryFileFormatSuite ()  { throw new RuntimeException(); }
  ...
  public  org.apache.hadoop.fs.FileStatus mockFileStatus (long length, long modificationTime)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  void testBinaryFileDataSource (java.lang.String pathGlobFilter)  { throw new RuntimeException(); }
  public  void testCreateFilterFunction (scala.collection.Seq<org.apache.spark.sql.sources.Filter> filters, scala.collection.Seq<scala.Tuple2<org.apache.hadoop.fs.FileStatus, java.lang.Object>> testCases)  { throw new RuntimeException(); }
  // not preceding
