 ...
 * information.
 */
public abstract class BucketedWriteSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SQLTestUtils {
  // not preceding
  ...
  // not preceding
  protected abstract  scala.collection.Seq<java.lang.String> fileFormatsToTest ()  ;
  // not preceding
