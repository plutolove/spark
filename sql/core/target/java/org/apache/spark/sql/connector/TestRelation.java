...
public  class TestRelation {
  ...
  static public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> output ()  { throw new RuntimeException(); }
  ...
  static protected  void copyTagsFrom (BaseType other)  { throw new RuntimeException(); }
  ...
  static public  void generateTreeString (int depth, scala.collection.Seq<java.lang.Object> lastChildren, scala.Function1<java.lang.String, scala.runtime.BoxedUnit> append, boolean verbose, java.lang.String prefix, boolean addSuffix, int maxFields, boolean printNodeId)  { throw new RuntimeException(); }
  ...
  static public  PlanType transformUpWithNewOutput (scala.PartialFunction<PlanType, scala.Tuple2<PlanType, scala.collection.Seq<scala.Tuple2<org.apache.spark.sql.catalyst.expressions.Attribute, org.apache.spark.sql.catalyst.expressions.Attribute>>>> rule, scala.Function1<PlanType, java.lang.Object> skipCond)  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.plans.logical.Statistics computeStats ()  { throw new RuntimeException(); }
  static public  boolean skipSchemaResolution ()  { throw new RuntimeException(); }
}
