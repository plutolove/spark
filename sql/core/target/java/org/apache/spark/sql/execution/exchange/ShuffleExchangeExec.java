...
/**
 * A {@link ShuffleDependency} that will partition rows of its child based on
...
public  class ShuffleExchangeExec extends org.apache.spark.sql.execution.exchange.Exchange implements org.apache.spark.sql.execution.exchange.ShuffleExchangeLike, scala.Product, scala.Serializable {
  ...
  public  boolean noUserSpecifiedNumPartition ()  { throw new RuntimeException(); }
  // not preceding
  public   ShuffleExchangeExec (org.apache.spark.sql.catalyst.plans.physical.Partitioning outputPartitioning, org.apache.spark.sql.execution.SparkPlan child, boolean noUserSpecifiedNumPartition)  { throw new RuntimeException(); }
  // not preceding
