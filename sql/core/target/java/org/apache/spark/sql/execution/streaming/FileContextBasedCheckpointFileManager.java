...
/** An implementation of {@link CheckpointFileManager} using Hadoop's {@link FileContext} API. */
public  class FileContextBasedCheckpointFileManager implements org.apache.spark.sql.execution.streaming.CheckpointFileManager, org.apache.spark.sql.execution.streaming.CheckpointFileManager.RenameHelperMethods, org.apache.spark.internal.Logging {
  // not preceding
  public   FileContextBasedCheckpointFileManager (org.apache.hadoop.fs.Path path, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
