...
public  class ContinuousSuiteBase extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest {
  ...
  // not preceding
  public   ContinuousSuiteBase ()  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.streaming.Trigger longContinuousTrigger ()  { throw new RuntimeException(); }
  // not preceding
  ...
  protected  void waitForRateSourceCommittedValue (org.apache.spark.sql.execution.streaming.continuous.ContinuousExecution query, scala.collection.immutable.Map<java.lang.Object, java.lang.Object> partitionIdToDesiredValue, long maxWaitTimeMs)  { throw new RuntimeException(); }
  protected  void waitForRateSourceTriggers (org.apache.spark.sql.execution.streaming.continuous.ContinuousExecution query, int numTriggers)  { throw new RuntimeException(); }
  // not preceding
