...
public  class PandasGroupUtils$ {
   ...
   */
  public static final PandasGroupUtils$ MODULE$ = null;
  public   PandasGroupUtils$ ()  { throw new RuntimeException(); }
  // not preceding
  public <T extends java.lang.Object> scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> executePython (scala.collection.Iterator<T> data, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.api.python.BasePythonRunner<T, org.apache.spark.sql.vectorized.ColumnarBatch> runner)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Tuple2<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute>, int[]> resolveArgOffsets (org.apache.spark.sql.execution.SparkPlan child, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> groupingAttributes)  { throw new RuntimeException(); }
}
