 ...
 */
public abstract class EvalPythonExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode {
  // not preceding
  public   EvalPythonExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.PythonUDF> udfs, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> resultAttrs, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
