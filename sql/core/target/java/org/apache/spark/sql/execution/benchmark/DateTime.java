...
public  class DateTime {
  static public  scala.Enumeration.Value DATE ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value TIMESTAMP ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value TIMESTAMP_INT96 ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value TIMESTAMP_MICROS ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value TIMESTAMP_MILLIS ()  { throw new RuntimeException(); }
