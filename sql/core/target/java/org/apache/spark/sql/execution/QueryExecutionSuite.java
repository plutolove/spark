...
public  class QueryExecutionSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.test.SharedSparkSession {
  public  org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig$ PatienceConfig ()  { throw new RuntimeException(); }
  // not preceding
  public   QueryExecutionSuite ()  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  public  void checkDumpedPlans (java.lang.String path, int expected)  { throw new RuntimeException(); }
  // not preceding
