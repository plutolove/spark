...
public  class ComplexTypesSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  ...
  public  void checkNamedStruct (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, int expectedCount)  { throw new RuntimeException(); }
  // not preceding
