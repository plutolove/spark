...
public  class JDBCSuite extends org.apache.spark.sql.QueryTest implements org.scalatest.BeforeAndAfter, org.scalatest.PrivateMethodTester, org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public   JDBCSuite ()  { throw new RuntimeException(); }
  ...
  public  void checkNumPartitions (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df, int expectedNumPartitions)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  byte[] testBytes ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  org.apache.spark.sql.jdbc.JdbcDialect testH2Dialect ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.jdbc.JdbcDialect testH2DialectTinyInt ()  { throw new RuntimeException(); }
  ...
  public  java.lang.String urlWithUserAndPass ()  { throw new RuntimeException(); }
  // not preceding
