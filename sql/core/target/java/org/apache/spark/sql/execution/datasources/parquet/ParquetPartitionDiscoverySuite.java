...
public abstract class ParquetPartitionDiscoverySuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.execution.datasources.parquet.ParquetTest, org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public   ParquetPartitionDiscoverySuite ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.catalyst.util.DateFormatter df ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  org.apache.spark.sql.catalyst.util.TimestampFormatter tf ()  { throw new RuntimeException(); }
  public  java.time.ZoneId timeZoneId ()  { throw new RuntimeException(); }
  // not preceding
