 ...
 */
public abstract class DataSourceScanRedactionTest extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public   DataSourceScanRedactionTest ()  { throw new RuntimeException(); }
  ...
  protected abstract  org.apache.hadoop.fs.Path getRootPath (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df)  ;
  protected final  boolean isIncluded (org.apache.spark.sql.execution.QueryExecution queryExecution, java.lang.String msg)  { throw new RuntimeException(); }
  // not preceding
