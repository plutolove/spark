...
public  class AllDataTypesScanSource implements org.apache.spark.sql.sources.SchemaRelationProvider {
  // not preceding
  public   AllDataTypesScanSource ()  { throw new RuntimeException(); }
  // not preceding
