...
public abstract class MetadataCacheSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public   MetadataCacheSuite ()  { throw new RuntimeException(); }
  ...
  // not preceding
  protected  void deleteOneFileInDirectory (java.io.File dir)  { throw new RuntimeException(); }
  // not preceding
