...
public abstract class CSVSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.execution.datasources.csv.TestCsvData {
  // not preceding
  ...
  public  void checkHeader (boolean multiLine)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  void testLineSeparator (java.lang.String lineSep, java.lang.String encoding, boolean inferSchema, int id)  { throw new RuntimeException(); }
  // not preceding
