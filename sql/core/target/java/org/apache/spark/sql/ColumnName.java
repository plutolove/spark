...
/**
 * Creates a new <code>StructField</code> of type boolean.
 * @since 1.3.0
 */
public  class ColumnName extends org.apache.spark.sql.Column {
  ...
  /**
   * Creates a new <code>StructField</code> of type array.
   * @since 1.3.0
  ...
  /**
   * Creates a new <code>StructField</code> of type map.
   * @since 1.3.0
  ...
  /**
   * Creates a new <code>StructField</code> of type string.
   * @since 1.3.0
   * @return (undocumented)
   */
  public  org.apache.spark.sql.types.StructField string ()  { throw new RuntimeException(); }
  /**
   * Creates a new <code>StructField</code> of type struct.
   * @since 1.3.0
  ...
  /**
   * Creates a new <code>StructField</code> of type timestamp.
   * @since 1.3.0
   * @return (undocumented)
   */
