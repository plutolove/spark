...
public  class ParquetTable extends org.apache.spark.sql.execution.datasources.v2.FileTable implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ParquetTable (java.lang.String name, org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.util.CaseInsensitiveStringMap options, scala.collection.Seq<java.lang.String> paths, scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema, java.lang.Class<? extends org.apache.spark.sql.execution.datasources.FileFormat> fallbackFileFormat)  { throw new RuntimeException(); }
  // not preceding
  public  org.apache.spark.sql.execution.datasources.v2.parquet.ParquetScanBuilder newScanBuilder (org.apache.spark.sql.util.CaseInsensitiveStringMap options)  { throw new RuntimeException(); }
