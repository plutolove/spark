...
public  class JdbcUtils$ implements org.apache.spark.internal.Logging {
   ...
   * @param options (undocumented)
   */
  public  void createTable (java.sql.Connection conn, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df, org.apache.spark.sql.execution.datasources.jdbc.JdbcOptionsInWrite options)  { throw new RuntimeException(); }
}
