...
// not preceding
public  class DOUBLE$ extends org.apache.spark.sql.execution.columnar.NativeColumnType<org.apache.spark.sql.types.DoubleType$> {
  /**
  ...
  public  void setField (org.apache.spark.sql.catalyst.InternalRow row, int ordinal, double value)  { throw new RuntimeException(); }
