...
public  class DataSource$ implements org.apache.spark.internal.Logging, scala.Serializable {
   ...
   * @return (undocumented)
   */
    scala.collection.Seq<org.apache.hadoop.fs.Path> checkAndGlobPathIfNecessary (scala.collection.Seq<java.lang.String> paths, org.apache.hadoop.conf.Configuration hadoopConf, boolean checkEmptyGlobPath, boolean checkFilesExist, boolean enableGlobbing)  { throw new RuntimeException(); }
  /**
