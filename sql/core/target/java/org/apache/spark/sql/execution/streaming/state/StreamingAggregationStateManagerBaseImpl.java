...
public abstract class StreamingAggregationStateManagerBaseImpl implements org.apache.spark.sql.execution.streaming.state.StreamingAggregationStateManager {
  ...
  public  scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.UnsafeRow> keys (org.apache.spark.sql.execution.streaming.state.StateStore store)  { throw new RuntimeException(); }
