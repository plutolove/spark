...
public  interface StreamingAggregationStateManager extends scala.Serializable {
  ...
  public  org.apache.spark.sql.catalyst.expressions.UnsafeRow get (org.apache.spark.sql.execution.streaming.state.StateStore store, org.apache.spark.sql.catalyst.expressions.UnsafeRow key)  ;
  /**
  ...
  public  scala.collection.Iterator<org.apache.spark.sql.execution.streaming.state.UnsafeRowPair> iterator (org.apache.spark.sql.execution.streaming.state.StateStore store)  ;
  /** Return an iterator containing all the keys in target state store. */
  public  scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.UnsafeRow> keys (org.apache.spark.sql.execution.streaming.state.StateStore store)  ;
  /** Return an iterator containing all the values in target state store. */
  public  scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.UnsafeRow> values (org.apache.spark.sql.execution.streaming.state.StateStore store)  ;
}
