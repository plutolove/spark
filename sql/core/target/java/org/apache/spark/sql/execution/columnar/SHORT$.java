...
// not preceding
public  class SHORT$ extends org.apache.spark.sql.execution.columnar.NativeColumnType<org.apache.spark.sql.types.ShortType$> {
  /**
  ...
  public  void setField (org.apache.spark.sql.catalyst.InternalRow row, int ordinal, short value)  { throw new RuntimeException(); }
  public  short getField (org.apache.spark.sql.catalyst.InternalRow row, int ordinal)  { throw new RuntimeException(); }
