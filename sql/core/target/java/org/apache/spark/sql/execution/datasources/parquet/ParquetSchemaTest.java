 ...
 */
public abstract class ParquetSchemaTest extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.execution.datasources.parquet.ParquetTest, org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  ...
  protected  void testCatalystToParquet (java.lang.String testName, org.apache.spark.sql.types.StructType sqlSchema, java.lang.String parquetSchema, boolean writeLegacyParquetFormat, scala.Enumeration.Value outputTimestampType)  { throw new RuntimeException(); }
  // not preceding
  ...
  protected  void testParquetToCatalyst (java.lang.String testName, org.apache.spark.sql.types.StructType sqlSchema, java.lang.String parquetSchema, boolean binaryAsString, boolean int96AsTimestamp)  { throw new RuntimeException(); }
  protected  void testSchema (java.lang.String testName, org.apache.spark.sql.types.StructType sqlSchema, java.lang.String parquetSchema, boolean binaryAsString, boolean int96AsTimestamp, boolean writeLegacyParquetFormat, scala.Enumeration.Value outputTimestampType)  { throw new RuntimeException(); }
  // not preceding
