...
/**
 * Asserts that a cached {@link Dataset} will be built using the given number of other cached results.
 */
public  class DatasetCacheSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.scalatest.concurrent.TimeLimits, org.apache.spark.sql.execution.adaptive.AdaptiveSparkPlanHelper {
  // not preceding
  public   DatasetCacheSuite ()  { throw new RuntimeException(); }
