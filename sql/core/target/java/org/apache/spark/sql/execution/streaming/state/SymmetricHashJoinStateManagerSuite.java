...
public  class SymmetricHashJoinStateManagerSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest, org.scalatest.BeforeAndAfter {
  ...
  // not preceding
  public   SymmetricHashJoinStateManagerSuite ()  { throw new RuntimeException(); }
  // not preceding
  protected  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> allNulls ()  { throw new RuntimeException(); }
  public  void append (int key, int value, org.apache.spark.sql.execution.streaming.state.SymmetricHashJoinStateManager manager)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  scala.collection.Seq<java.lang.Object> get (int key, org.apache.spark.sql.execution.streaming.state.SymmetricHashJoinStateManager manager)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.expressions.AttributeReference inputValueAttribWithWatermark ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> inputValueAttribs ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.expressions.UnsafeProjection inputValueGen ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.types.StructType inputValueSchema ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> joinKeyExprs ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.expressions.UnsafeProjection joinKeyGen ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  long numRows (org.apache.spark.sql.execution.streaming.state.SymmetricHashJoinStateManager manager)  { throw new RuntimeException(); }
  // not preceding
  protected  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> person ()  { throw new RuntimeException(); }
  /** Remove keys (and corresponding values) where `time <= threshold` */
  public  void removeByKey (long threshold, org.apache.spark.sql.execution.streaming.state.SymmetricHashJoinStateManager manager)  { throw new RuntimeException(); }
  /** Remove values where `time <= threshold` */
  public  void removeByValue (long watermark, org.apache.spark.sql.execution.streaming.state.SymmetricHashJoinStateManager manager)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  org.apache.spark.sql.catalyst.expressions.UnsafeRow toInputValue (int i)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.expressions.UnsafeRow toJoinKeyRow (int i)  { throw new RuntimeException(); }
  public  int toValueInt (org.apache.spark.sql.catalyst.expressions.UnsafeRow inputValueRow)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  void withJoinStateManager (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> inputValueAttribs, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> joinKeyExprs, int stateFormatVersion, scala.Function1<org.apache.spark.sql.execution.streaming.state.SymmetricHashJoinStateManager, scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
}
