...
// not preceding
public  class ConsoleTable$ implements org.apache.spark.sql.connector.catalog.Table, org.apache.spark.sql.connector.catalog.SupportsWrite {
  /**
   * Static reference to the singleton instance of this Scala object.
   */
  public static final ConsoleTable$ MODULE$ = null;
  public   ConsoleTable$ ()  { throw new RuntimeException(); }
  // not preceding
