 ...
 * Drop all the tables
 */
public abstract class BenchmarkQueryTest extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  // not preceding
  public   BenchmarkQueryTest ()  { throw new RuntimeException(); }
  ...
  protected  void checkGeneratedCode (org.apache.spark.sql.execution.SparkPlan plan, boolean checkMethodCodeSize)  { throw new RuntimeException(); }
  // not preceding
