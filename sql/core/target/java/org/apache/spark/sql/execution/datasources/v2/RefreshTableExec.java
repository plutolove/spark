...
public  class RefreshTableExec extends org.apache.spark.sql.execution.datasources.v2.V2CommandExec implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   RefreshTableExec (org.apache.spark.sql.SparkSession session, org.apache.spark.sql.connector.catalog.TableCatalog catalog, org.apache.spark.sql.connector.catalog.Identifier ident)  { throw new RuntimeException(); }
  // not preceding
