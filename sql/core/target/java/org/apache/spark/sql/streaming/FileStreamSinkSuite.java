...
public abstract class FileStreamSinkSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest {
  ...
  // not preceding
  public   FileStreamSinkSuite ()  { throw new RuntimeException(); }
  ...
  protected abstract  void checkQueryExecution (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df)  ;
  // not preceding
  ...
  public  void testFormat (scala.Option<java.lang.String> format)  { throw new RuntimeException(); }
