...
public  class RateStreamProviderSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest {
  // not preceding
  public  class AdvanceRateManualClock implements org.apache.spark.sql.streaming.StreamTest.AddData, scala.Product, scala.Serializable {
    static public abstract  R apply (T1 v1)  ;
    static public  java.lang.String toString ()  { throw new RuntimeException(); }
    // not preceding
    public  long seconds ()  { throw new RuntimeException(); }
    // not preceding
    public   AdvanceRateManualClock (long seconds)  { throw new RuntimeException(); }
    // not preceding
  ...
  // not preceding
  public  class AdvanceRateManualClock$ extends scala.runtime.AbstractFunction1<java.lang.Object, org.apache.spark.sql.execution.streaming.sources.RateStreamProviderSuite.AdvanceRateManualClock> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final AdvanceRateManualClock$ MODULE$ = null;
    public   AdvanceRateManualClock$ ()  { throw new RuntimeException(); }
  }
  ...
  // not preceding
  public   RateStreamProviderSuite ()  { throw new RuntimeException(); }
