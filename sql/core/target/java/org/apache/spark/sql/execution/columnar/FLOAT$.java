...
// not preceding
public  class FLOAT$ extends org.apache.spark.sql.execution.columnar.NativeColumnType<org.apache.spark.sql.types.FloatType$> {
  /**
  ...
  public  void setField (org.apache.spark.sql.catalyst.InternalRow row, int ordinal, float value)  { throw new RuntimeException(); }
