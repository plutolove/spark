...
public  class FakeExternalSourceThree implements org.apache.spark.sql.sources.RelationProvider, org.apache.spark.sql.sources.DataSourceRegister {
  // not preceding
  public   FakeExternalSourceThree ()  { throw new RuntimeException(); }
