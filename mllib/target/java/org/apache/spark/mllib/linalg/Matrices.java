...
public  class Matrices {
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.mllib.linalg.Matrix sparse (int numRows, int numCols, int[] colPtrs, int[] rowIndices, double[] values)  { throw new RuntimeException(); }
  /**
   * Creates a Matrix instance from a breeze matrix.
   * @param breeze a breeze matrix
   * @return a Matrix instance
   */
  static   org.apache.spark.mllib.linalg.Matrix fromBreeze (breeze.linalg.Matrix<java.lang.Object> breeze)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.mllib.linalg.Matrix zeros (int numRows, int numCols)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.mllib.linalg.Matrix ones (int numRows, int numCols)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.mllib.linalg.Matrix eye (int n)  { throw new RuntimeException(); }
  /**
   * Generate a sparse Identity Matrix in <code>Matrix</code> format.
   * @param n number of rows and columns of the matrix
   * @return <code>Matrix</code> with size <code>n</code> x <code>n</code> and values of ones on the diagonal
   */
  static public  org.apache.spark.mllib.linalg.Matrix speye (int n)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.mllib.linalg.Matrix rand (int numRows, int numCols, java.util.Random rng)  { throw new RuntimeException(); }
  /**
   ...
   * @return <code>Matrix</code> with size <code>numRows</code> x <code>numCols</code> and values in U(0, 1)
   */
  static public  org.apache.spark.mllib.linalg.Matrix sprand (int numRows, int numCols, double density, java.util.Random rng)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.mllib.linalg.Matrix randn (int numRows, int numCols, java.util.Random rng)  { throw new RuntimeException(); }
  /**
   ...
   * @return <code>Matrix</code> with size <code>numRows</code> x <code>numCols</code> and values in N(0, 1)
   */
  static public  org.apache.spark.mllib.linalg.Matrix sprandn (int numRows, int numCols, double density, java.util.Random rng)  { throw new RuntimeException(); }
  /**
   ...
   *         on the diagonal
   */
  static public  org.apache.spark.mllib.linalg.Matrix diag (org.apache.spark.mllib.linalg.Vector vector)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.mllib.linalg.Matrix horzcat (org.apache.spark.mllib.linalg.Matrix[] matrices)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.mllib.linalg.Matrix vertcat (org.apache.spark.mllib.linalg.Matrix[] matrices)  { throw new RuntimeException(); }
  /**
   * Convert new linalg type to spark.mllib type.  Light copy; only copies references
   * @param m (undocumented)
   * @return (undocumented)
   */
  static public  org.apache.spark.mllib.linalg.Matrix fromML (org.apache.spark.ml.linalg.Matrix m)  { throw new RuntimeException(); }
}
