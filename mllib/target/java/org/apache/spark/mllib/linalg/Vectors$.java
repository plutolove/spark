...
public  class Vectors$ {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.linalg.Vector fromJson (java.lang.String json)  { throw new RuntimeException(); }
    org.apache.spark.mllib.linalg.Vector parseNumeric (Object any)  { throw new RuntimeException(); }
  /**
   * Creates a vector instance from a breeze vector.
   * @param breezeVector (undocumented)
   * @return (undocumented)
   */
    org.apache.spark.mllib.linalg.Vector fromBreeze (breeze.linalg.Vector<java.lang.Object> breezeVector)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  double norm (org.apache.spark.mllib.linalg.Vector vector, double p)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  double sqdist (org.apache.spark.mllib.linalg.Vector v1, org.apache.spark.mllib.linalg.Vector v2)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    double sqdist (org.apache.spark.mllib.linalg.SparseVector v1, org.apache.spark.mllib.linalg.DenseVector v2)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.linalg.Vector fromML (org.apache.spark.ml.linalg.Vector v)  { throw new RuntimeException(); }
}
