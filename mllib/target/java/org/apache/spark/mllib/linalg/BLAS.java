...
// not preceding
public  class BLAS {
  static   com.github.fommil.netlib.BLAS f2jBLAS ()  { throw new RuntimeException(); }
  static   com.github.fommil.netlib.BLAS getBLAS (int vectorSize)  { throw new RuntimeException(); }
  /**
   * y += a * x
  ...
  static   com.github.fommil.netlib.BLAS nativeBLAS ()  { throw new RuntimeException(); }
  /**
