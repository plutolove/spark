...
public  class GradientDescentSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.mllib.util.MLlibTestSparkContext, org.scalatest.Matchers {
  // not preceding
  ...
  static public  scala.collection.Seq<org.apache.spark.mllib.regression.LabeledPoint> generateGDInput (double offset, double scale, int nPoints, int seed)  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  public   GradientDescentSuite ()  { throw new RuntimeException(); }
}
