...
public  class PowerIterationClusteringSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.mllib.util.MLlibTestSparkContext {
  // not preceding
  static public  org.apache.spark.mllib.clustering.PowerIterationClusteringModel createModel (org.apache.spark.SparkContext sc, int k, int nPoints)  { throw new RuntimeException(); }
  static public  void checkEqual (org.apache.spark.mllib.clustering.PowerIterationClusteringModel a, org.apache.spark.mllib.clustering.PowerIterationClusteringModel b)  { throw new RuntimeException(); }
