...
public  class KMeansModel implements org.apache.spark.mllib.util.Saveable, scala.Serializable, org.apache.spark.mllib.pmml.PMMLExportable {
  ...
  public  double trainingCost ()  { throw new RuntimeException(); }
    int numIter ()  { throw new RuntimeException(); }
  // not preceding
  public   KMeansModel (org.apache.spark.mllib.linalg.Vector[] clusterCenters, java.lang.String distanceMeasure, double trainingCost, int numIter)  { throw new RuntimeException(); }
     KMeansModel (org.apache.spark.mllib.linalg.Vector[] clusterCenters, java.lang.String distanceMeasure)  { throw new RuntimeException(); }
