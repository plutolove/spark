...
public  class RegressionMetrics implements org.apache.spark.internal.Logging {
  // not preceding
  public   RegressionMetrics (org.apache.spark.rdd.RDD<? extends scala.Product> predictionAndObservations, boolean throughOrigin)  { throw new RuntimeException(); }
  // not preceding
  public   RegressionMetrics (org.apache.spark.rdd.RDD<? extends scala.Product> predictionAndObservations)  { throw new RuntimeException(); }
  /**
   * An auxiliary constructor taking a DataFrame.
   * @param predictionAndObservations a DataFrame with two double columns:
   *                                  prediction and observation
