...
public  class PrefixSpanModel<Item extends java.lang.Object> implements org.apache.spark.mllib.util.Saveable, scala.Serializable {
  ...
  static public  class SaveLoadV1_0$ {
    ...
    public <Item extends java.lang.Object> org.apache.spark.mllib.fpm.PrefixSpanModel<Item> loadImpl (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> freqSequences, Item sample, scala.reflect.ClassTag<Item> evidence$4)  { throw new RuntimeException(); }
  }
  // not preceding
