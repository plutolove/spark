...
public  class FPGrowthModel<Item extends java.lang.Object> implements org.apache.spark.mllib.util.Saveable, scala.Serializable {
  ...
  static public  class SaveLoadV1_0$ {
    ...
    public <Item extends java.lang.Object> org.apache.spark.mllib.fpm.FPGrowthModel<Item> loadImpl (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> freqItemsets, Item sample, scala.reflect.ClassTag<Item> evidence$3)  { throw new RuntimeException(); }
  }
  // not preceding
  ...
  public  scala.collection.immutable.Map<Item, java.lang.Object> itemSupport ()  { throw new RuntimeException(); }
  // not preceding
  public   FPGrowthModel (org.apache.spark.rdd.RDD<org.apache.spark.mllib.fpm.FPGrowth.FreqItemset<Item>> freqItemsets, scala.collection.immutable.Map<Item, java.lang.Object> itemSupport, scala.reflect.ClassTag<Item> evidence$1)  { throw new RuntimeException(); }
  // not preceding
  public   FPGrowthModel (org.apache.spark.rdd.RDD<org.apache.spark.mllib.fpm.FPGrowth.FreqItemset<Item>> freqItemsets, scala.reflect.ClassTag<Item> evidence$2)  { throw new RuntimeException(); }
  /**
   * Generates association rules for the <code>Item</code>s in {@link freqItemsets}.
   * @param confidence minimal confidence of the rules produced
   * @return (undocumented)
