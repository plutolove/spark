...
public  class DecisionTreeModel implements scala.Serializable, org.apache.spark.mllib.util.Saveable {
  ...
  static public  class SaveLoadV1_0$ {
    ...
    public  class PredictData implements scala.Product, scala.Serializable {
      // not preceding
      static public  org.apache.spark.mllib.tree.model.DecisionTreeModel.SaveLoadV1_0.PredictData apply (org.apache.spark.mllib.tree.model.Predict p)  { throw new RuntimeException(); }
      static public  org.apache.spark.mllib.tree.model.DecisionTreeModel.SaveLoadV1_0.PredictData apply (org.apache.spark.sql.Row r)  { throw new RuntimeException(); }
      // not preceding
    ...
    public  class PredictData$ implements scala.Serializable {
       ...
       * Static reference to the singleton instance of this Scala object.
       */
      public static final PredictData$ MODULE$ = null;
    ...
    public  class SplitData implements scala.Product, scala.Serializable {
      // not preceding
      static public  org.apache.spark.mllib.tree.model.DecisionTreeModel.SaveLoadV1_0.SplitData apply (org.apache.spark.mllib.tree.model.Split s)  { throw new RuntimeException(); }
      static public  org.apache.spark.mllib.tree.model.DecisionTreeModel.SaveLoadV1_0.SplitData apply (org.apache.spark.sql.Row r)  { throw new RuntimeException(); }
      // not preceding
    ...
    public  class NodeData implements scala.Product, scala.Serializable {
      // not preceding
      static public  org.apache.spark.mllib.tree.model.DecisionTreeModel.SaveLoadV1_0.NodeData apply (int treeId, org.apache.spark.mllib.tree.model.Node n)  { throw new RuntimeException(); }
      static public  org.apache.spark.mllib.tree.model.DecisionTreeModel.SaveLoadV1_0.NodeData apply (org.apache.spark.sql.Row r)  { throw new RuntimeException(); }
      // not preceding
