...
public  class StreamingLinearRegressionSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.streaming.LocalStreamingContext, org.apache.spark.streaming.TestSuiteBase {
  // not preceding
  public   StreamingLinearRegressionSuite ()  { throw new RuntimeException(); }
  public  void assertEqual (double v1, double v2, double epsilon)  { throw new RuntimeException(); }
  // not preceding
