...
public  class IDFModel implements scala.Serializable {
  static   double[] transformDense (org.apache.spark.mllib.linalg.Vector idf, double[] values)  { throw new RuntimeException(); }
  static   scala.Tuple2<int[], double[]> transformSparse (org.apache.spark.mllib.linalg.Vector idf, int[] indices, double[] values)  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
     IDFModel (org.apache.spark.mllib.linalg.Vector idf, long[] docFreq, long numDocs)  { throw new RuntimeException(); }
  // not preceding
