 ...
 * Series B, 1984.</a>
 */
  class IterativelyReweightedLeastSquares implements scala.Serializable {
  // not preceding
  public   IterativelyReweightedLeastSquares (org.apache.spark.ml.optim.WeightedLeastSquaresModel initialModel, scala.Function2<org.apache.spark.ml.feature.OffsetInstance, org.apache.spark.ml.optim.WeightedLeastSquaresModel, scala.Tuple2<java.lang.Object, java.lang.Object>> reweightFunc, boolean fitIntercept, double regParam, int maxIter, double tol)  { throw new RuntimeException(); }
  // not preceding
  public  org.apache.spark.ml.optim.IterativelyReweightedLeastSquaresModel fit (org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.OffsetInstance> instances, org.apache.spark.ml.util.OptionalInstrumentation instr, int depth)  { throw new RuntimeException(); }
  ...
  public  scala.Function2<org.apache.spark.ml.feature.OffsetInstance, org.apache.spark.ml.optim.WeightedLeastSquaresModel, scala.Tuple2<java.lang.Object, java.lang.Object>> reweightFunc ()  { throw new RuntimeException(); }
