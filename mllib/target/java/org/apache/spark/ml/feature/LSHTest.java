 ...
 * @param <T>  The class type of lsh
 * @return A tuple of two doubles, representing the false positive and false negative rate
 */
// not preceding
public  class LSHTest {
  // not preceding
  static public <T extends org.apache.spark.ml.feature.LSHModel<T>> scala.Tuple2<java.lang.Object, java.lang.Object> calculateLSHProperty (org.apache.spark.sql.Dataset<?> dataset, org.apache.spark.ml.feature.LSH<T> lsh, double distFP, double distFN)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public <T extends org.apache.spark.ml.feature.LSHModel<T>> scala.Tuple2<java.lang.Object, java.lang.Object> calculateApproxNearestNeighbors (org.apache.spark.ml.feature.LSH<T> lsh, org.apache.spark.sql.Dataset<?> dataset, org.apache.spark.ml.linalg.Vector key, int k, boolean singleProbe)  { throw new RuntimeException(); }
  /**
   ...
   * @return A tuple of two doubles, representing precision and recall rate
   */
  static public <T extends org.apache.spark.ml.feature.LSHModel<T>> scala.Tuple2<java.lang.Object, java.lang.Object> calculateApproxSimilarityJoin (org.apache.spark.ml.feature.LSH<T> lsh, org.apache.spark.sql.Dataset<?> datasetA, org.apache.spark.sql.Dataset<?> datasetB, double threshold)  { throw new RuntimeException(); }
}
