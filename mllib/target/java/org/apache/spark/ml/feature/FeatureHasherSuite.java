...
public  class FeatureHasherSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  static   int murmur3FeatureIdx (int numFeatures, Object term)  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  public   FeatureHasherSuite ()  { throw new RuntimeException(); }
}
