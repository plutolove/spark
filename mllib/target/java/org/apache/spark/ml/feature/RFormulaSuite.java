...
public  class RFormulaSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  ...
  // not preceding
  public   RFormulaSuite ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public <A extends java.lang.Object> void testRFormulaTransform (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> dataframe, org.apache.spark.ml.feature.RFormulaModel formulaModel, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> expected, scala.collection.Seq<org.apache.spark.ml.attribute.AttributeGroup> expectedAttributes, org.apache.spark.sql.Encoder<A> evidence$1)  { throw new RuntimeException(); }
  // not preceding
