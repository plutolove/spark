...
public  class NGramSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  ...
  // not preceding
  public   NGramSuite ()  { throw new RuntimeException(); }
  ...
  public  void testNGram (org.apache.spark.ml.feature.NGram t, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> dataFrame)  { throw new RuntimeException(); }
  // not preceding
