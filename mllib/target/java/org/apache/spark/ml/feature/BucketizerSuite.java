...
public  class BucketizerSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  static public  double linearSearchForBuckets (double[] splits, double feature)  { throw new RuntimeException(); }
  /** Check all values in splits, plus values between all splits. */
  static public  void checkBinarySearch (double[] splits)  { throw new RuntimeException(); }
  /** Checks if bucketized results match expected ones. */
  static public  void checkBucketResults (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> bucketResult, scala.collection.Seq<java.lang.String> resultColumns, scala.collection.Seq<java.lang.String> expectedColumns)  { throw new RuntimeException(); }
