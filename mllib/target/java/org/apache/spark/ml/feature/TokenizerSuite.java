...
public  class TokenizerSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  ...
  // not preceding
  public   TokenizerSuite ()  { throw new RuntimeException(); }
  // not preceding
