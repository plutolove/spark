...
public  class ImputerSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  static public  void iterateStrategyTest (boolean isMultiCol, org.apache.spark.ml.feature.Imputer imputer, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df)  { throw new RuntimeException(); }
  static public  void verifyTransformResult (java.lang.String strategy, java.lang.String inputCol, java.lang.String outputCol, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> resultDF)  { throw new RuntimeException(); }
  // not preceding
