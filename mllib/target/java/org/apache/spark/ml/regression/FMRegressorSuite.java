...
public  class FMRegressorSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  ...
  static public  scala.Tuple2<org.apache.spark.sql.Dataset<org.apache.spark.sql.Row>, double[]> generateFactorInteractionInput (org.apache.spark.sql.SparkSession spark, int factorSize, int numFeatures, int numSamples, int seed, boolean fitIntercept, boolean fitLinear)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> crossDataset ()  { throw new RuntimeException(); }
  public  void beforeAll ()  { throw new RuntimeException(); }
  public  void checkMSE (boolean fitIntercept, boolean fitLinear)  { throw new RuntimeException(); }
}
