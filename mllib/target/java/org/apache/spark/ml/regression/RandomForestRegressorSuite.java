...
/**
 * Test suite for {@link RandomForestRegressor}.
 */
public  class RandomForestRegressorSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  static public  void compareAPIs (org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.LabeledPoint> data, org.apache.spark.ml.regression.RandomForestRegressor rf, scala.collection.immutable.Map<java.lang.Object, java.lang.Object> categoricalFeatures)  { throw new RuntimeException(); }
  ...
  public  void regressionTestWithContinuousFeatures (org.apache.spark.ml.regression.RandomForestRegressor rf)  { throw new RuntimeException(); }
}
