 ...
 */
public  class AFTSurvivalRegressionSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  ...
  // not preceding
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetUnivariate ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetMultivariate ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetUnivariateScaled ()  { throw new RuntimeException(); }
  public  void beforeAll ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.ml.regression.AFTPoint> generateAFTInput (int numFeatures, double[] xMean, double[] xVariance, int nPoints, int seed, double weibullShape, double weibullScale, double exponentialMean)  { throw new RuntimeException(); }
}
