...
public  class IsotonicRegressionSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  ...
  // not preceding
  public   IsotonicRegressionSuite ()  { throw new RuntimeException(); }
}
