 ...
 */
public  class GeneralizedLinearRegressionSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  ...
  static public  scala.collection.Seq<org.apache.spark.ml.feature.LabeledPoint> generateGeneralizedLinearRegressionInput (double intercept, double[] coefficients, double[] xMean, double[] xVariance, int nPoints, int seed, double noiseLevel, java.lang.String family, java.lang.String link)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetGaussianIdentity ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetGaussianLog ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetGaussianInverse ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetBinomial ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetPoissonLog ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetPoissonLogWithZero ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetPoissonIdentity ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetPoissonSqrt ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetGammaInverse ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetGammaIdentity ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> datasetGammaLog ()  { throw new RuntimeException(); }
