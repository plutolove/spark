...
public  class CrossValidatorSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  static public abstract class MyModel extends org.apache.spark.ml.Model<org.apache.spark.ml.tuning.CrossValidatorSuite.MyModel> {
    // not preceding
    public   MyModel ()  { throw new RuntimeException(); }
  }
  // not preceding
  static public  class MyEstimator extends org.apache.spark.ml.Estimator<org.apache.spark.ml.tuning.CrossValidatorSuite.MyModel> implements org.apache.spark.ml.param.shared.HasInputCol {
    // not preceding
    public   MyEstimator (java.lang.String uid)  { throw new RuntimeException(); }
    public  org.apache.spark.ml.tuning.CrossValidatorSuite.MyEstimator copy (org.apache.spark.ml.param.ParamMap extra)  { throw new RuntimeException(); }
    // not preceding
    public  org.apache.spark.ml.tuning.CrossValidatorSuite.MyModel fit (org.apache.spark.sql.Dataset<?> dataset)  { throw new RuntimeException(); }
    // not preceding
  ...
  static public  class MyEvaluator extends org.apache.spark.ml.evaluation.Evaluator {
    ...
    public  org.apache.spark.ml.tuning.CrossValidatorSuite.MyEvaluator copy (org.apache.spark.ml.param.ParamMap extra)  { throw new RuntimeException(); }
    // not preceding
  ...
  // not preceding
  public   CrossValidatorSuite ()  { throw new RuntimeException(); }
  // not preceding
