 ...
 *     - Normalize importances for tree to sum to 1 (only if <code>perTreeNormalization</code> is <code>true</code>).
 ...
 * param:  perTreeNormalization By default this is set to <code>true</code> and it means that the importances
 *                             of each tree are normalized before being summed. If set to <code>false</code>,
...
public  class TreeEnsembleModel$ {
  ...
  // not preceding
  public <M extends org.apache.spark.ml.tree.DecisionTreeModel> org.apache.spark.ml.linalg.Vector featureImportances (M[] trees, int numFeatures, boolean perTreeNormalization)  { throw new RuntimeException(); }
  /**
