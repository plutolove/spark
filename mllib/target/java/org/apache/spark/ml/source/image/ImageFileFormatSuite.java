...
public  class ImageFileFormatSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.mllib.util.MLlibTestSparkContext {
  // not preceding
  public   ImageFileFormatSuite ()  { throw new RuntimeException(); }
  // not preceding
