...
public  class KMeansSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest, org.apache.spark.ml.util.PMMLReadWriteTest {
  // not preceding
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> generateKMeansData (org.apache.spark.sql.SparkSession spark, int rows, int dim, int k)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> generateSparseData (org.apache.spark.sql.SparkSession spark, int rows, int dim, int seed)  { throw new RuntimeException(); }
  /**
