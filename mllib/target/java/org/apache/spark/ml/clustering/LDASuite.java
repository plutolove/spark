 ...
 */
public  class LDASuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> generateLDAData (org.apache.spark.sql.SparkSession spark, int rows, int k, int vocabSize)  { throw new RuntimeException(); }
  /**
   * Mapping from all Params to valid settings which differ from the defaults.
   * This is useful for tests which need to exercise all Params, such as save/load.
   * This excludes input columns to simplify some tests.
