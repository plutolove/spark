 ...
 */
public  class LinearSVCSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  ...
  static public  scala.collection.Seq<org.apache.spark.ml.feature.LabeledPoint> generateSVMInput (double intercept, double[] weights, int nPoints, int seed)  { throw new RuntimeException(); }
  static public  void checkModels (org.apache.spark.ml.classification.LinearSVCModel model1, org.apache.spark.ml.classification.LinearSVCModel model2)  { throw new RuntimeException(); }
  // not preceding
  ...
  // not preceding
  public   LinearSVCSuite ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<?> smallBinaryDataset ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<?> smallValidationDataset ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<?> binaryDataset ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<?> smallSparseBinaryDataset ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<?> smallSparseValidationDataset ()  { throw new RuntimeException(); }
