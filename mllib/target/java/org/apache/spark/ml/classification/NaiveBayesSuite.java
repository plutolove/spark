...
public  class NaiveBayesSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
   ...
   * @return (undocumented)
   */
  static public  scala.collection.immutable.Map<java.lang.String, java.lang.Object> allParamSettingsForGaussian ()  { throw new RuntimeException(); }
  static public  scala.collection.Seq<org.apache.spark.ml.feature.LabeledPoint> generateNaiveBayesInput (double[] pi, double[][] theta, int nPoints, int seed, java.lang.String modelType, int sample)  { throw new RuntimeException(); }
  static public  scala.collection.Seq<org.apache.spark.ml.feature.LabeledPoint> generateGaussianNaiveBayesInput (double[] pi, double[][] theta, double[][] sigma, int nPoints, int seed)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  org.apache.spark.sql.Dataset<?> bernoulliDataset ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<?> gaussianDataset ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<?> gaussianDataset2 ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<?> complementDataset ()  { throw new RuntimeException(); }
  public  void beforeAll ()  { throw new RuntimeException(); }
  public  void validatePrediction (scala.collection.Seq<org.apache.spark.sql.Row> predictionAndLabels)  { throw new RuntimeException(); }
  public  void validateModelFit (org.apache.spark.ml.linalg.Vector piData, org.apache.spark.ml.linalg.Matrix thetaData, org.apache.spark.ml.linalg.Matrix sigmaData, org.apache.spark.ml.classification.NaiveBayesModel model)  { throw new RuntimeException(); }
  public  org.apache.spark.ml.linalg.Vector expectedMultinomialProbabilities (org.apache.spark.ml.classification.NaiveBayesModel model, org.apache.spark.ml.linalg.Vector feature)  { throw new RuntimeException(); }
  public  org.apache.spark.ml.linalg.Vector expectedBernoulliProbabilities (org.apache.spark.ml.classification.NaiveBayesModel model, org.apache.spark.ml.linalg.Vector feature)  { throw new RuntimeException(); }
  public  org.apache.spark.ml.linalg.Vector expectedGaussianProbabilities (org.apache.spark.ml.classification.NaiveBayesModel model, org.apache.spark.ml.linalg.Vector feature)  { throw new RuntimeException(); }
  public  void validateProbabilities (scala.collection.Seq<org.apache.spark.sql.Row> featureAndProbabilities, org.apache.spark.ml.classification.NaiveBayesModel model, java.lang.String modelType)  { throw new RuntimeException(); }
}
