...
/**
 * Test suite for {@link RandomForestClassifier}.
 */
public  class RandomForestClassifierSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.ml.util.MLTest, org.apache.spark.ml.util.DefaultReadWriteTest {
  // not preceding
  static public  void compareAPIs (org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.LabeledPoint> data, org.apache.spark.ml.classification.RandomForestClassifier rf, scala.collection.immutable.Map<java.lang.Object, java.lang.Object> categoricalFeatures, int numClasses)  { throw new RuntimeException(); }
  ...
  public  void binaryClassificationTestWithContinuousFeatures (org.apache.spark.ml.classification.RandomForestClassifier rf)  { throw new RuntimeException(); }
}
