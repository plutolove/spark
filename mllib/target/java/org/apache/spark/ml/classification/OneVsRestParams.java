 ...
 * @group param
 */
public  interface OneVsRestParams extends org.apache.spark.ml.classification.ClassifierParams, org.apache.spark.ml.classification.ClassifierTypeTrait, org.apache.spark.ml.param.shared.HasWeightCol {
  /**
   * param for the base binary classifier that we reduce multiclass classification into.
   * The base classifier input and output columns are ignored in favor of
   * the ones specified in {@link OneVsRest}.
