 ...
 */
// not preceding
public  class MLTestingUtils {
  // not preceding
  static public <T extends org.apache.spark.ml.Estimator<?>> void checkCopyAndUids (T estimator, org.apache.spark.ml.Model<?> model)  { throw new RuntimeException(); }
  static public <M extends org.apache.spark.ml.Model<M>, T extends org.apache.spark.ml.Estimator<M>> void checkNumericTypes (T estimator, org.apache.spark.sql.SparkSession spark, boolean isClassification, scala.Function2<M, M, scala.runtime.BoxedUnit> check)  { throw new RuntimeException(); }
  static public <T extends org.apache.spark.ml.evaluation.Evaluator> void checkNumericTypes (T evaluator, org.apache.spark.sql.SparkSession spark)  { throw new RuntimeException(); }
  ...
  static public  scala.collection.immutable.Map<org.apache.spark.sql.types.NumericType, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row>> genEvaluatorDFWithNumericLabelCol (org.apache.spark.sql.SparkSession spark, java.lang.String labelColName, java.lang.String predictionColName)  { throw new RuntimeException(); }
  /**
   * Given a DataFrame, generate two output DataFrames: one having the original rows oversampled
   * an integer number of times, and one having the original rows but with a column of weights
   * proportional to the number of oversampled instances in the oversampled DataFrames.
   ...
   * @return (undocumented)
   */
  static public  scala.Tuple2<org.apache.spark.sql.Dataset<org.apache.spark.ml.feature.Instance>, org.apache.spark.sql.Dataset<org.apache.spark.ml.feature.Instance>> genEquivalentOversampledAndWeightedInstances (org.apache.spark.sql.Dataset<org.apache.spark.ml.feature.LabeledPoint> data, long seed)  { throw new RuntimeException(); }
  /**
   ...
   * @param seed (undocumented)
   */
  static public <M extends org.apache.spark.ml.Model<M>, E extends org.apache.spark.ml.Estimator<M>> void testOversamplingVsWeighting (org.apache.spark.sql.Dataset<org.apache.spark.ml.feature.LabeledPoint> data, E estimator, scala.Function2<M, M, scala.runtime.BoxedUnit> modelEquals, long seed)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public <M extends org.apache.spark.ml.Model<M>, E extends org.apache.spark.ml.Estimator<M>> void testOutliersWithSmallWeights (org.apache.spark.sql.Dataset<org.apache.spark.ml.feature.LabeledPoint> data, E estimator, int numClasses, scala.Function2<M, M, scala.runtime.BoxedUnit> modelEquals, int outlierRatio)  { throw new RuntimeException(); }
  /**
   ...
   * @param modelEquals (undocumented)
   */
  static public <M extends org.apache.spark.ml.Model<M>, E extends org.apache.spark.ml.Estimator<M>> void testArbitrarilyScaledWeights (org.apache.spark.sql.Dataset<org.apache.spark.ml.feature.LabeledPoint> data, E estimator, scala.Function2<M, M, scala.runtime.BoxedUnit> modelEquals)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.Tuple3<org.apache.spark.sql.Dataset<org.apache.spark.sql.Row>, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row>, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row>> generateArrayFeatureDataset (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> dataset, java.lang.String featuresColName)  { throw new RuntimeException(); }
  static public <M extends org.apache.spark.ml.PredictionModel<?, M>> void modelPredictionEquals (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> data, scala.Function2<java.lang.Object, java.lang.Object, java.lang.Object> compareFunc, double fractionInTol, M model1, M model2)  { throw new RuntimeException(); }
