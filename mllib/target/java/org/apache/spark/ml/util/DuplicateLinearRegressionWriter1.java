...
public  class DuplicateLinearRegressionWriter1 implements org.apache.spark.ml.util.MLFormatRegister {
  // not preceding
  public   DuplicateLinearRegressionWriter1 ()  { throw new RuntimeException(); }
  // not preceding
