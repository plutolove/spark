...
public  class SchemaUtils$ {
   ...
   * @return new schema
   */
  public  org.apache.spark.sql.types.StructType updateAttributeGroupSize (org.apache.spark.sql.types.StructType schema, java.lang.String colName, int size)  { throw new RuntimeException(); }
  /**
   ...
   * @return new schema
   */
  public  org.apache.spark.sql.types.StructType updateNumValues (org.apache.spark.sql.types.StructType schema, java.lang.String colName, int numValues)  { throw new RuntimeException(); }
  /**
   ...
   * @return new schema
   */
  public  org.apache.spark.sql.types.StructType updateNumeric (org.apache.spark.sql.types.StructType schema, java.lang.String colName)  { throw new RuntimeException(); }
  /**
   ...
   * @return new schema
   */
  public  org.apache.spark.sql.types.StructType updateField (org.apache.spark.sql.types.StructType schema, org.apache.spark.sql.types.StructField field, boolean overwriteMetadata)  { throw new RuntimeException(); }
  /**
   ...
   * @param colName column name
   */
  public  void validateVectorCompatibleColumn (org.apache.spark.sql.types.StructType schema, java.lang.String colName)  { throw new RuntimeException(); }
}
