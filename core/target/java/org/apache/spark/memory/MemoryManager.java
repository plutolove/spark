 ...
 */
 abstract class MemoryManager implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  public final  long offHeapExecutionMemoryUsed ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public final  long offHeapStorageMemoryUsed ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public final  long onHeapExecutionMemoryUsed ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public final  long onHeapStorageMemoryUsed ()  { throw new RuntimeException(); }
  /**
