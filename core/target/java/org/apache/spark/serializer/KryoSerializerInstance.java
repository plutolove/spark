...
/**
 * A re-used {@link Kryo} instance. Methods will borrow this instance by calling <code>borrowKryo()</code>, do
 * their work, then release the instance by calling <code>releaseKryo()</code>. Logically, this is a caching
 ...
 */
  ...
  // not preceding
  public   KryoSerializerInstance (org.apache.spark.serializer.KryoSerializer ks, boolean useUnsafe, boolean usePool)  { throw new RuntimeException(); }
  // not preceding
