...
public  class HadoopFSDelegationTokenProviderSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.Matchers {
  // not preceding
  public   HadoopFSDelegationTokenProviderSuite ()  { throw new RuntimeException(); }
  // not preceding
