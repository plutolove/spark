...
public  class JsonProtocol {
  ...
  /**
   * Export the {@link ApplicationInfo} to a Json objec. An {@link ApplicationInfo} consists of the
   ...
   *         <code>memoryperslave</code> minimal memory in MB required to each executor
   *         <code>resourcesperslave</code> minimal resources required to each executor
   ...
   *         of the master
   *         <code>status</code> status of the master, see {@link MasterState}
   * @param obj (undocumented)
   */
