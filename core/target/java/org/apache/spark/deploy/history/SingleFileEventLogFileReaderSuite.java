...
public  class SingleFileEventLogFileReaderSuite extends org.apache.spark.deploy.history.EventLogFileReadersSuite {
  // not preceding
  public   SingleFileEventLogFileReaderSuite ()  { throw new RuntimeException(); }
