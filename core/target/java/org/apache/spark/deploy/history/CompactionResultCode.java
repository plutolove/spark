...
// not preceding
public  class CompactionResultCode {
  // not preceding
  static public  scala.Enumeration.Value SUCCESS ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value NOT_ENOUGH_FILES ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value LOW_SCORE_FOR_COMPACTION ()  { throw new RuntimeException(); }
