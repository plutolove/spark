...
public  class TestSparkApplication implements org.apache.spark.deploy.SparkApplication, org.scalatest.Matchers {
  // not preceding
  public   TestSparkApplication ()  { throw new RuntimeException(); }
  // not preceding
