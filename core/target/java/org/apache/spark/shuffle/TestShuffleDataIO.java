...
public  class TestShuffleDataIO implements org.apache.spark.shuffle.api.ShuffleDataIO {
  // not preceding
  public   TestShuffleDataIO (org.apache.spark.SparkConf sparkConf)  { throw new RuntimeException(); }
