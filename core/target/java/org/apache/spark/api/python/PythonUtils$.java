...
public  class PythonUtils$ {
  ...
  // not preceding
  public  java.lang.String PY4J_ZIP_NAME ()  { throw new RuntimeException(); }
  /** Get the PYTHONPATH for PySpark, either from SPARK_HOME, if it is set, or from our JAR */
  ...
  public  boolean isEncryptionEnabled (org.apache.spark.api.java.JavaSparkContext sc)  { throw new RuntimeException(); }
  public  long getBroadcastThreshold (org.apache.spark.api.java.JavaSparkContext sc)  { throw new RuntimeException(); }
  public  int getSparkBufferSize (org.apache.spark.api.java.JavaSparkContext sc)  { throw new RuntimeException(); }
}
