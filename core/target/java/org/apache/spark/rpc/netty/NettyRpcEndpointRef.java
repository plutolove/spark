 ...
 */
  ...
  public <T extends java.lang.Object> scala.concurrent.Future<T> ask (Object message, org.apache.spark.rpc.RpcTimeout timeout, scala.reflect.ClassTag<T> evidence$5)  { throw new RuntimeException(); }
  public <T extends java.lang.Object> org.apache.spark.rpc.AbortableRpcFuture<T> askAbortable (Object message, org.apache.spark.rpc.RpcTimeout timeout, scala.reflect.ClassTag<T> evidence$4)  { throw new RuntimeException(); }
  // not preceding
