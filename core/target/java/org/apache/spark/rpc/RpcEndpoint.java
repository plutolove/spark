...
public  interface RpcEndpoint {
  ...
  public  void onStop ()  ;
  /**
   * Process messages from <code>RpcEndpointRef.send</code> or <code>RpcCallContext.reply</code>. If receiving a
   * unmatched message, <code>SparkException</code> will be thrown and sent to <code>onError</code>.
   * @return (undocumented)
   */
