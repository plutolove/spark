...
public  class FakeTask extends org.apache.spark.scheduler.Task<java.lang.Object> {
  ...
  static public  org.apache.spark.scheduler.TaskSet createTaskSet (int numTasks, int stageId, int stageAttemptId, int priority, scala.collection.Seq<scala.collection.Seq<org.apache.spark.scheduler.TaskLocation>> prefLocs)  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.scheduler.TaskSet createBarrierTaskSet (int numTasks, int stageId, int stageAttemptId, int priority, scala.collection.Seq<scala.collection.Seq<org.apache.spark.scheduler.TaskLocation>> prefLocs)  { throw new RuntimeException(); }
  // not preceding
