...
public  class TaskSchedulerImpl$ {
   ...
   * @return the number of max task slots
   */
  public  int calculateAvailableSlots (org.apache.spark.scheduler.TaskSchedulerImpl scheduler, int[] availableCpus, scala.collection.immutable.Map<java.lang.String, java.lang.Object>[] availableResources)  { throw new RuntimeException(); }
  /**
