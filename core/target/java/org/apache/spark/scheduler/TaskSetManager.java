 ...
 */
   ...
   * @param availableResources (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.scheduler.TaskDescription> resourceOffer (java.lang.String execId, java.lang.String host, scala.Enumeration.Value maxLocality, scala.collection.immutable.Map<java.lang.String, scala.collection.Seq<java.lang.String>> availableResources) throws org.apache.spark.TaskNotSerializableException { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    scala.Option<java.lang.Object> getCompletelyBlacklistedTaskIfAny (scala.collection.mutable.HashMap<java.lang.String, scala.collection.mutable.HashSet<java.lang.String>> hostToExecutors)  { throw new RuntimeException(); }
    void abortSinceCompletelyBlacklisted (int indexInTaskSet)  { throw new RuntimeException(); }
  /**
