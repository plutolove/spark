...
public  class FakeTask$ implements scala.Serializable {
  ...
  public  org.apache.spark.scheduler.TaskSet createTaskSet (int numTasks, int stageId, int stageAttemptId, int priority, scala.collection.Seq<scala.collection.Seq<org.apache.spark.scheduler.TaskLocation>> prefLocs)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.scheduler.TaskSet createBarrierTaskSet (int numTasks, int stageId, int stageAttemptId, int priority, scala.collection.Seq<scala.collection.Seq<org.apache.spark.scheduler.TaskLocation>> prefLocs)  { throw new RuntimeException(); }
}
