...
/**
 * Min partition number to use {@link HighlyCompressedMapStatus}. A bit ugly here because in test
...
public  class MapStatus$ {
  ...
  public  org.apache.spark.scheduler.MapStatus apply (org.apache.spark.storage.BlockManagerId loc, long[] uncompressedSizes, long mapTaskId)  { throw new RuntimeException(); }
  /**
