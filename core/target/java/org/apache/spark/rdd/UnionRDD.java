...
public  class UnionRDD<T extends java.lang.Object> extends org.apache.spark.rdd.RDD<T> {
  // not preceding
  static   scala.collection.parallel.ForkJoinTaskSupport partitionEvalTaskSupport ()  { throw new RuntimeException(); }
  ...
  // not preceding
    boolean isPartitionListingParallel ()  { throw new RuntimeException(); }
