...
public  class ThreadUtils {
  static public  java.util.concurrent.ExecutorService sameThreadExecutorService ()  { throw new RuntimeException(); }
  /**
   * An <code>ExecutionContextExecutor</code> that runs each task in the thread that invokes <code>execute/submit</code>.
   * The caller should make sure the tasks running in this <code>ExecutionContextExecutor</code> are short and
   * never block.
   ...
   * @return (undocumented)
   */
  static public  java.util.concurrent.ScheduledExecutorService newDaemonThreadPoolScheduledExecutor (java.lang.String threadNamePrefix, int numThreads)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  java.util.concurrent.ForkJoinPool newForkJoinPool (java.lang.String prefix, int maxThreadNumber)  { throw new RuntimeException(); }
  /**
  ...
  static public <T extends java.lang.Object> T awaitResult (java.util.concurrent.Future<T> future, scala.concurrent.duration.Duration atMost) throws org.apache.spark.SparkException { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public <T extends java.lang.Object> scala.concurrent.Awaitable awaitReady (scala.concurrent.Awaitable<T> awaitable, scala.concurrent.duration.Duration atMost) throws org.apache.spark.SparkException { throw new RuntimeException(); }
  static public  void shutdown (java.util.concurrent.ExecutorService executor, scala.concurrent.duration.Duration gracePeriod)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public <I extends java.lang.Object, O extends java.lang.Object> scala.collection.Seq<O> parmap (scala.collection.Seq<I> in, java.lang.String prefix, int maxThreads, scala.Function1<I, O> f)  { throw new RuntimeException(); }
}
