...
public  class JsonProtocol {
  ...
  static public  org.json4s.JsonAST.JValue stageExecutorMetricsToJson (org.apache.spark.scheduler.SparkListenerStageExecutorMetrics metrics)  { throw new RuntimeException(); }
  static public  org.json4s.JsonAST.JValue blockUpdateToJson (org.apache.spark.scheduler.SparkListenerBlockUpdated blockUpdate)  { throw new RuntimeException(); }
  /** ------------------------------------------------------------------- *
  ...
  static public  org.json4s.JsonAST.JArray accumulablesToJson (scala.collection.Iterable<org.apache.spark.scheduler.AccumulableInfo> accumulables)  { throw new RuntimeException(); }
  ...
  static public  org.json4s.JsonAST.JValue executorMetricsToJson (org.apache.spark.executor.ExecutorMetrics executorMetrics)  { throw new RuntimeException(); }
  ...
  static public  org.json4s.JsonAST.JValue resourcesMapToJson (scala.collection.Map<java.lang.String, org.apache.spark.resource.ResourceInformation> m)  { throw new RuntimeException(); }
  static public  org.json4s.JsonAST.JValue blockUpdatedInfoToJson (org.apache.spark.storage.BlockUpdatedInfo blockUpdatedInfo)  { throw new RuntimeException(); }
  /** ------------------------------ *
  ...
  static public  org.apache.spark.executor.ExecutorMetrics executorMetricsFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.scheduler.SparkListenerStageExecutorMetrics stageExecutorMetricsFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  static public  org.apache.spark.scheduler.SparkListenerBlockUpdated blockUpdateFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  /** --------------------------------------------------------------------- *
  ...
  static public  org.apache.spark.storage.BlockUpdatedInfo blockUpdatedInfoFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  static public  scala.collection.Map<java.lang.String, org.apache.spark.resource.ResourceInformation> resourcesMapFromJson (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  /** -------------------------------- *
