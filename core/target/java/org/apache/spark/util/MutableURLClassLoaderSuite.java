...
public  class MutableURLClassLoaderSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.Matchers {
  // not preceding
  public   MutableURLClassLoaderSuite ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  java.net.URL[] fileUrlsChild ()  { throw new RuntimeException(); }
  public  java.net.URL[] fileUrlsParent ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  java.net.URL[] urls ()  { throw new RuntimeException(); }
  // not preceding
