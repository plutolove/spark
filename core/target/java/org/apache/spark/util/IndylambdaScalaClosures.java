...
public  class IndylambdaScalaClosures {
   ...
   * @return (undocumented)
   */
  static public  boolean isLambdaMetafactory (org.apache.xbean.asm7.Handle bsmHandle)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  boolean isLambdaBodyCapturingOuter (org.apache.xbean.asm7.Handle handle, java.lang.String ownerInternalName)  { throw new RuntimeException(); }
  /**
