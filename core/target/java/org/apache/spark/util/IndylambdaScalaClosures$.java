...
public  class IndylambdaScalaClosures$ implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  public  boolean isLambdaMetafactory (org.apache.xbean.asm7.Handle bsmHandle)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean isLambdaBodyCapturingOuter (org.apache.xbean.asm7.Handle handle, java.lang.String ownerInternalName)  { throw new RuntimeException(); }
  /**
