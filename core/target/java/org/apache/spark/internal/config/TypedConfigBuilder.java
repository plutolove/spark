...
/** Apply a transformation to the user-provided values of the config entry. */
  ...
  /** Creates a {@link ConfigEntry} with a function to determine the default value */
  public  org.apache.spark.internal.config.ConfigEntry<T> createWithDefaultFunction (scala.Function0<T> defaultFunc)  { throw new RuntimeException(); }
  /**
