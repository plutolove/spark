 ...
 * set-if-not-exists operation ({@link lockNewBlockForWriting()}) and are removed
 * by {@link removeBlock()}.
 */
   ...
   * @param taskAttemptId (undocumented)
   */
  public  void unlock (org.apache.spark.storage.BlockId blockId, scala.Option<java.lang.Object> taskAttemptId)  { throw new RuntimeException(); }
}
