...
public  class RDDInfo implements scala.math.Ordered<org.apache.spark.storage.RDDInfo> {
  ...
  // not preceding
  public   RDDInfo (int id, java.lang.String name, int numPartitions, org.apache.spark.storage.StorageLevel storageLevel, boolean isBarrier, scala.collection.Seq<java.lang.Object> parentIds, java.lang.String callSite, scala.Option<org.apache.spark.rdd.RDDOperationScope> scope)  { throw new RuntimeException(); }
  // not preceding
