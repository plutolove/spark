 ...
 */
  ...
  // not preceding
  // Select(Apply(Select(This(TypeName("ShuffleMetricsSource")), TermName("metricRegistry")), List()), TermName("registerAll"))
  // Apply(Select(This(TypeName("ShuffleMetricsSource")), TermName("metricRegistry")), List())
  // Select(This(TypeName("ShuffleMetricsSource")), TermName("metricRegistry"))
  // This(TypeName("ShuffleMetricsSource"))
  // Select(This(TypeName("ShuffleMetricsSource")), TermName("metricSet"))
  // This(TypeName("ShuffleMetricsSource"))
  static public  class RemoteBlockDownloadFileManager implements org.apache.spark.network.shuffle.DownloadFileManager, org.apache.spark.internal.Logging {
    // not preceding
    public   RemoteBlockDownloadFileManager (org.apache.spark.storage.BlockManager blockManager)  { throw new RuntimeException(); }
