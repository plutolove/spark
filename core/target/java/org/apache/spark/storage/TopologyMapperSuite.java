...
public  class TopologyMapperSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.Matchers, org.scalatest.BeforeAndAfter, org.apache.spark.LocalSparkContext {
  // not preceding
  public   TopologyMapperSuite ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  void cleanup (java.io.File testFile)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  java.io.File createPropertiesFile (scala.collection.immutable.Map<java.lang.String, java.lang.String> props)  { throw new RuntimeException(); }
  // not preceding
