...
public  class BlockManagerProactiveReplicationSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.storage.BlockManagerReplicationBehavior {
  // not preceding
  public   BlockManagerProactiveReplicationSuite ()  { throw new RuntimeException(); }
  // not preceding
  ...
  public  void testProactiveReplication (int replicationFactor)  { throw new RuntimeException(); }
  // not preceding
