...
public  class TestUtils$ {
   ...
   * @return (undocumented)
   */
  public  java.net.URL createJar (scala.collection.Seq<java.io.File> files, java.io.File jarFile, scala.Option<java.lang.String> directoryPrefix, scala.Option<java.lang.String> mainClass)  { throw new RuntimeException(); }
  // not preceding
   ...
   */
  public  void assertExceptionMsg (java.lang.Throwable exception, java.lang.String msg, boolean ignoreCase)  { throw new RuntimeException(); }
  /**
  ...
  public  boolean isPythonVersionAtLeast38 ()  { throw new RuntimeException(); }
  /**
  ...
  public <T extends java.lang.Object> T withHttpConnection (java.net.URL url, java.lang.String method, scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers, scala.Function1<java.net.HttpURLConnection, T> fn)  { throw new RuntimeException(); }
  /**
  ...
  public  java.lang.String createTempJsonFile (java.io.File dir, java.lang.String prefix, org.json4s.JsonAST.JValue jsonValue)  { throw new RuntimeException(); }
  /** Creates a temp bash script that prints the given output. */
  public  java.lang.String createTempScriptWithExpectedOutput (java.io.File dir, java.lang.String prefix, java.lang.String output)  { throw new RuntimeException(); }
}
