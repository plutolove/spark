...
public  class UIUtils$ implements org.apache.spark.internal.Logging {
  ...
  public  java.lang.String uiRoot (javax.servlet.http.HttpServletRequest request)  { throw new RuntimeException(); }
  public  java.lang.String prependBaseUri (javax.servlet.http.HttpServletRequest request, java.lang.String basePath, java.lang.String resource)  { throw new RuntimeException(); }
  public  scala.collection.Seq<scala.xml.Node> commonHeaderNodes (javax.servlet.http.HttpServletRequest request)  { throw new RuntimeException(); }
  public  scala.collection.Seq<scala.xml.Node> vizHeaderNodes (javax.servlet.http.HttpServletRequest request)  { throw new RuntimeException(); }
  public  scala.collection.Seq<scala.xml.Node> dataTablesHeaderNodes (javax.servlet.http.HttpServletRequest request)  { throw new RuntimeException(); }
  /** Returns a spark page with correctly formatted headers */
  public  scala.collection.Seq<scala.xml.Node> headerSparkPage (javax.servlet.http.HttpServletRequest request, java.lang.String title, scala.Function0<scala.collection.Seq<scala.xml.Node>> content, org.apache.spark.ui.SparkUITab activeTab, scala.Option<java.lang.String> helpText, boolean showVisualization, boolean useDataTables)  { throw new RuntimeException(); }
  /** Returns a page with the spark css/js and a simple format. Used for scheduler UI. */
  public  scala.collection.Seq<scala.xml.Node> basicSparkPage (javax.servlet.http.HttpServletRequest request, scala.Function0<scala.collection.Seq<scala.xml.Node>> content, java.lang.String title, boolean useDataTables)  { throw new RuntimeException(); }
  ...
  public  javax.ws.rs.core.Response buildErrorResponse (javax.ws.rs.core.Response.Status status, java.lang.String msg)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Tuple2<java.lang.Object, scala.collection.immutable.Map<java.lang.String, java.lang.Object>>[] durationDataPadding (scala.Tuple2<java.lang.Object, java.util.Map<java.lang.String, java.lang.Long>>[] values)  { throw new RuntimeException(); }
  public  scala.collection.Seq<scala.xml.Node> detailsUINode (boolean isMultiline, java.lang.String message)  { throw new RuntimeException(); }
}
