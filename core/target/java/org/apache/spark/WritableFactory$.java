...
public  class WritableFactory$ implements scala.Serializable {
  ...
  // not preceding
   <T extends java.lang.Object, W extends org.apache.hadoop.io.Writable> org.apache.spark.WritableFactory<T> simpleWritableFactory (scala.Function1<T, W> convert, scala.reflect.ClassTag<T> evidence$20, scala.reflect.ClassTag<W> evidence$21)  { throw new RuntimeException(); }
  ...
  public <T extends org.apache.hadoop.io.Writable> org.apache.spark.WritableFactory<T> writableWritableFactory (scala.reflect.ClassTag<T> evidence$22)  { throw new RuntimeException(); }
}
