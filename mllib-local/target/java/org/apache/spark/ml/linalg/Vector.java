...
public  interface Vector extends scala.Serializable {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.ml.linalg.Vector compressed ()  ;
  /**
   * Makes a deep copy of this vector.
   * @return (undocumented)
   */
  public  org.apache.spark.ml.linalg.Vector copy ()  ;
  /**
   ...
   * @return (undocumented)
   */
  public  double dot (org.apache.spark.ml.linalg.Vector v)  ;
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.ml.linalg.DenseVector toDense ()  ;
  /**
   * Converts this vector to a sparse vector with all explicit zeros removed.
   * @return (undocumented)
   */
  public  org.apache.spark.ml.linalg.SparseVector toSparse ()  ;
  /**
   ...
   * @return (undocumented)
   */
    org.apache.spark.ml.linalg.SparseVector toSparseWithSize (int nnz)  ;
}
