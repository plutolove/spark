...
public  class SparseMatrix$ implements scala.Serializable {
  ...
  // not preceding
    scala.Option<scala.Tuple6<java.lang.Object, java.lang.Object, int[], int[], double[], java.lang.Object>> unapply (org.apache.spark.ml.linalg.SparseMatrix sm)  { throw new RuntimeException(); }
  /**
   * Generate a <code>SparseMatrix</code> from Coordinate List (COO) format. Input must be an array of
   * (i, j, value) tuples. Entries that have duplicate values of i and j are
   * added together. Tuples where value is equal to zero will be omitted.
   ...
   * @return The corresponding <code>SparseMatrix</code>
   */
  public  org.apache.spark.ml.linalg.SparseMatrix fromCOO (int numRows, int numCols, scala.collection.Iterable<scala.Tuple3<java.lang.Object, java.lang.Object, java.lang.Object>> entries)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.ml.linalg.SparseMatrix speye (int n)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.ml.linalg.SparseMatrix sprand (int numRows, int numCols, double density, java.util.Random rng)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.ml.linalg.SparseMatrix sprandn (int numRows, int numCols, double density, java.util.Random rng)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.ml.linalg.SparseMatrix spdiag (org.apache.spark.ml.linalg.Vector vector)  { throw new RuntimeException(); }
}
