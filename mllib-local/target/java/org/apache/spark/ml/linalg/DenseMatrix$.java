...
public  class DenseMatrix$ implements scala.Serializable {
  ...
  // not preceding
    scala.Option<scala.Tuple4<java.lang.Object, java.lang.Object, double[], java.lang.Object>> unapply (org.apache.spark.ml.linalg.DenseMatrix dm)  { throw new RuntimeException(); }
  /**
   * Generate a <code>DenseMatrix</code> consisting of zeros.
   * @param numRows number of rows of the matrix
   * @param numCols number of columns of the matrix
