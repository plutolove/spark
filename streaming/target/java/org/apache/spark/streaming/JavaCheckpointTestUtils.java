...
// not preceding
public  class JavaCheckpointTestUtils {
  // not preceding
  ...
  static public  org.apache.spark.streaming.Duration batchDuration ()  { throw new RuntimeException(); }
  ...
  static public  void beforeFunction ()  { throw new RuntimeException(); }
  static public  void afterFunction ()  { throw new RuntimeException(); }
  ...
  static public <V extends java.lang.Object> scala.collection.Seq<scala.collection.Seq<V>> runStreams (org.apache.spark.streaming.StreamingContext ssc, int numBatches, int numExpectedOutput, scala.Function0<scala.runtime.BoxedUnit> preStop, scala.reflect.ClassTag<V> evidence$9)  { throw new RuntimeException(); }
  static public <V extends java.lang.Object> scala.Function0<scala.runtime.BoxedUnit> runStreams$default$4 ()  { throw new RuntimeException(); }
  static public <V extends java.lang.Object> scala.collection.Seq<scala.collection.Seq<scala.collection.Seq<V>>> runStreamsWithPartitions (org.apache.spark.streaming.StreamingContext ssc, int numBatches, int numExpectedOutput, scala.Function0<scala.runtime.BoxedUnit> preStop, scala.reflect.ClassTag<V> evidence$10)  { throw new RuntimeException(); }
  static public <V extends java.lang.Object> scala.Function0<scala.runtime.BoxedUnit> runStreamsWithPartitions$default$4 ()  { throw new RuntimeException(); }
  ...
  static protected abstract  void org$apache$spark$streaming$TestSuiteBase$_setter_$conf_$eq (org.apache.spark.SparkConf x$1)  ;
  static protected abstract  void org$apache$spark$streaming$TestSuiteBase$_setter_$eventuallyTimeout_$eq (org.scalatest.concurrent.PatienceConfiguration.Timeout x$1)  ;
  static public <T extends java.lang.Object> org.apache.spark.streaming.api.java.JavaDStream<T> attachTestInputStream (org.apache.spark.streaming.api.java.JavaStreamingContext ssc, java.util.List<java.util.List<T>> data, int numPartitions)  { throw new RuntimeException(); }
  static public <T extends java.lang.Object, This extends org.apache.spark.streaming.api.java.JavaDStreamLike<T, This, R>, R extends org.apache.spark.api.java.JavaRDDLike<T, R>> void attachTestOutputStream (org.apache.spark.streaming.api.java.JavaDStreamLike<T, This, R> dstream)  { throw new RuntimeException(); }
  static public <V extends java.lang.Object> java.util.List<java.util.List<V>> runStreams (org.apache.spark.streaming.api.java.JavaStreamingContext ssc, int numBatches, int numExpectedOutput)  { throw new RuntimeException(); }
  static public <V extends java.lang.Object> java.util.List<java.util.List<java.util.List<V>>> runStreamsWithPartitions (org.apache.spark.streaming.api.java.JavaStreamingContext ssc, int numBatches, int numExpectedOutput)  { throw new RuntimeException(); }
}
